...
angular.module("openshiftConsole")
   ...
   */
  .directive("oscAutoscaling", function(HPAService, LimitRangesService, DEFAULT_HPA_CPU_TARGET) {
    return {
      restrict: 'E',
      scope: {
        autoscaling: "=model",
      ...
      link: function(scope) {
        ...
        scope.$watch('project', function() {
          ...
          var defaultTargetCPU = DEFAULT_HPA_CPU_TARGET;
          if (scope.isRequestCalculated) {
            // Convert to percent of request to set in the HPA resource.
            defaultTargetCPU = 
              HPAService.convertLimitPercentToRequest(DEFAULT_HPA_CPU_TARGET, scope.project);
          }
          ...
          scope.defaultTargetCPUDisplayValue = DEFAULT_HPA_CPU_TARGET;
