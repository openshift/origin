  ...
  .controller('OverviewController',
    ...
    ProjectsService
      ...
      .then(_.spread(function(project, context) {
        ...
        $scope.hpaByDC = {}, $scope.hpaByRC = {};
        var isDCAutoscaled = function(name) {
          return $scope.hpaByDC[name] && $scope.hpaByDC[name].length;
        };

        var isRCAutoscaled = function(name) {
          return $scope.hpaByRC[name] && $scope.hpaByRC[name].length;
        };
        ...
        watches.push(DataService.watch({
          ...
          angular.forEach(horizontalPodAutoscalers.by("metadata.name"), function(hpa) {
            ...
            case "DeploymentConfig":
              $scope.hpaByDC[name] = $scope.hpaByDC[name] || [];
              $scope.hpaByDC[name].push(hpa);
              break;
            case "ReplicationController":
              $scope.hpaByRC[name] = $scope.hpaByRC[name] || [];
              $scope.hpaByRC[name].push(hpa);
              break;
            default:
