...
angular.module('openshiftConsole')
  .controller('SettingsController', function ($routeParams, $scope, DataService, AlertMessageService, $filter, $modal, $location, LabelFilter, $timeout, Logger, ProjectsService) {
