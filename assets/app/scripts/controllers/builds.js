...
angular.module('openshiftConsole')
  .controller('BuildsController', function ($scope, $routeParams, AlertMessageService, DataService, ProjectsService, $filter, LabelFilter, Logger, $location, $anchorScroll, BuildsService) {
    $scope.builds = {};
