...
angular.module('openshiftConsole')
  .controller('DeploymentsController', function ($scope, $routeParams, AlertMessageService, DataService, $filter, LabelFilter, Logger, ImageStreamResolver, DeploymentsService, ProjectsService) {
