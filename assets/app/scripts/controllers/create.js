...
angular.module('openshiftConsole')
  .controller('CreateController', function ($filter, $location, $routeParams, $scope, DataService, ProjectsService, descriptionFilter, imageStreamTagAnnotationFilter, hashSizeFilter, tagsFilter, uidFilter, LabelFilter, Logger) {
