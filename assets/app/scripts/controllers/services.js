...
angular.module('openshiftConsole')
  .controller('ServicesController', function ($scope, $routeParams, AlertMessageService, DataService, $filter, LabelFilter, Logger, $location, $anchorScroll, ProjectsService) {
