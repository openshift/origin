...
## Table of Contents
  - [Missing Owners (72)](#Missing-Owners-72)
    - [Certificates (34)](#Certificates-34)
    - [Certificate Authority Bundles (38)](#Certificate-Authority-Bundles-38)
  ...
  - [kube-apiserver (7)](#kube-apiserver-7)
...
22. ns/openshift-machine-config-operator secret/machine-config-server-tls

      **Description:** 
      

23. ns/openshift-monitoring secret/federate-client-certs

      **Description:** 
      

24. ns/openshift-monitoring secret/metrics-client-certs

      **Description:** 
      

25. ns/openshift-monitoring secret/prometheus-adapter-d42u3nbkeofr3

      **Description:** 
      

26. ns/openshift-network-node-identity secret/network-node-identity-ca

      **Description:** 
      

27. ns/openshift-network-node-identity secret/network-node-identity-cert

      **Description:** 
      

28. ns/openshift-oauth-apiserver secret/openshift-authenticator-certs

      **Description:** 
      

29. ns/openshift-operator-lifecycle-manager secret/packageserver-service-cert

      **Description:** 
      

30. ns/openshift-operator-lifecycle-manager secret/pprof-cert

      **Description:** 
      

31. ns/openshift-ovn-kubernetes secret/ovn-ca

      **Description:** 
      

32. ns/openshift-ovn-kubernetes secret/ovn-cert

      **Description:** 
      

33. ns/openshift-ovn-kubernetes secret/signer-ca

      **Description:** 
      

34. ns/openshift-ovn-kubernetes secret/signer-cert
...
### Certificate Authority Bundles (38)
...
4. ns/openshift-config-managed configmap/kube-apiserver-aggregator-client-ca

      **Description:** 
      

5. ns/openshift-config-managed configmap/kube-apiserver-client-ca

      **Description:** 
      

6. ns/openshift-config-managed configmap/kube-apiserver-server-ca

      **Description:** 
      

7. ns/openshift-config-managed configmap/kubelet-bootstrap-kubeconfig

      **Description:** 
      

8. ns/openshift-config-managed configmap/kubelet-serving-ca

      **Description:** 
      

9. ns/openshift-config-managed configmap/oauth-serving-cert

      **Description:** 
      

10. ns/openshift-console configmap/default-ingress-cert

      **Description:** 
      

11. ns/openshift-console configmap/oauth-serving-cert

      **Description:** 
      

12. ns/openshift-controller-manager configmap/client-ca

      **Description:** 
      

13. ns/openshift-kube-apiserver configmap/aggregator-client-ca

      **Description:** 
      

14. ns/openshift-kube-apiserver configmap/client-ca

      **Description:** 
      

15. ns/openshift-kube-apiserver configmap/kube-apiserver-server-ca

      **Description:** 
      

16. ns/openshift-kube-apiserver configmap/kubelet-serving-ca

      **Description:** 
      

17. ns/openshift-kube-apiserver-operator configmap/kube-apiserver-to-kubelet-client-ca

      **Description:** 
      

18. ns/openshift-kube-apiserver-operator configmap/kube-control-plane-signer-ca

      **Description:** 
      

19. ns/openshift-kube-apiserver-operator configmap/loadbalancer-serving-ca

      **Description:** 
      

20. ns/openshift-kube-apiserver-operator configmap/localhost-recovery-serving-ca

      **Description:** 
      

21. ns/openshift-kube-apiserver-operator configmap/localhost-serving-ca

      **Description:** 
      

22. ns/openshift-kube-apiserver-operator configmap/node-system-admin-ca

      **Description:** 
      

23. ns/openshift-kube-apiserver-operator configmap/service-network-serving-ca

      **Description:** 
      

24. ns/openshift-kube-controller-manager configmap/aggregator-client-ca

      **Description:** 
      

25. ns/openshift-kube-controller-manager configmap/client-ca

      **Description:** 
      

26. ns/openshift-kube-controller-manager configmap/serviceaccount-ca

      **Description:** 
      

27. ns/openshift-kube-controller-manager-operator configmap/csr-controller-ca

      **Description:** 
      

28. ns/openshift-kube-controller-manager-operator configmap/csr-controller-signer-ca

      **Description:** 
      

29. ns/openshift-kube-controller-manager-operator configmap/csr-signer-ca

      **Description:** 
      

30. ns/openshift-kube-scheduler configmap/serviceaccount-ca

      **Description:** 
      

31. ns/openshift-monitoring configmap/alertmanager-trusted-ca-bundle-2ua4n9ob5qr8o

      **Description:** 
      

32. ns/openshift-monitoring configmap/kubelet-serving-ca-bundle

      **Description:** 
      

33. ns/openshift-monitoring configmap/prometheus-trusted-ca-bundle-2ua4n9ob5qr8o

      **Description:** 
      

34. ns/openshift-monitoring configmap/thanos-querier-trusted-ca-bundle-2ua4n9ob5qr8o

      **Description:** 
      

35. ns/openshift-network-node-identity configmap/network-node-identity-ca

      **Description:** 
      

36. ns/openshift-ovn-kubernetes configmap/ovn-ca

      **Description:** 
      

37. ns/openshift-ovn-kubernetes configmap/signer-ca

      **Description:** 
      

38. ns/openshift-route-controller-manager configmap/client-ca
