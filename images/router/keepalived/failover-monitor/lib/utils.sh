...
#
#  Examples:
#      scrub "router\!@#@$%$^&*()-+=1_{}|[]\\:;'<>?,./ha-failover"
#         # -> router_1_ha_failover
#
#      scrub "router-1"  # -> router_1
#
function scrub() {
...
function expand_ip_ranges() {
  ...
  for iprange in $(echo "$vips" | tr "," " "); do
...
#
#     vrrp_instance_basename "router-1"  # -> router_1_VIP
#
...
#
#     generate_vrrp_instance_name router-1  # -> router_1_VIP_0
#
