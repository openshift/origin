...
replace (
	...
	github.com/openshift/cluster-control-plane-machine-set-operator => github.com/sunzhaohua2/cluster-control-plane-machine-set-operator v0.0.0-20260210000000-0f353f4d13bf
