...
require (
	...
	github.com/openshift/library-go v0.0.0-20221130160900-19a7df021cd5
...
replace (
	...
	k8s.io/kubernetes => github.com/openshift/kubernetes v1.25.1-0.20221111191542-2a247dec611e
