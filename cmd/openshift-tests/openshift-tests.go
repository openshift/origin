...
func bindOptions(opt *testginkgo.Options, flags *pflag.FlagSet) {
	...
	flags.StringVar(&opt.FocusRegex, "run", opt.FocusRegex, "Regular expression of tests to run.")
	flags.StringVar(&opt.SkipRegex, "skip", opt.SkipRegex, "Regular expression of tests to skip.")
