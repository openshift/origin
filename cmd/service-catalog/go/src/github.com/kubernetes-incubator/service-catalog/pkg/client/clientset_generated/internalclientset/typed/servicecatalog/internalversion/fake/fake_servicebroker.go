...
func (c *FakeServiceBrokers) Create(serviceBroker *servicecatalog.ServiceBroker) (result *servicecatalog.ServiceBroker, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(servicebrokersResource, serviceBroker), &servicecatalog.ServiceBroker{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeServiceBrokers) Update(serviceBroker *servicecatalog.ServiceBroker) (result *servicecatalog.ServiceBroker, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(servicebrokersResource, serviceBroker), &servicecatalog.ServiceBroker{})
	if obj == nil {
		return nil, err
	}
	return obj.(*servicecatalog.ServiceBroker), err
...
func (c *FakeServiceBrokers) UpdateStatus(serviceBroker *servicecatalog.ServiceBroker) (*servicecatalog.ServiceBroker, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(servicebrokersResource, "status", serviceBroker), &servicecatalog.ServiceBroker{})
	if obj == nil {
		return nil, err
	}
	return obj.(*servicecatalog.ServiceBroker), err
...
func (c *FakeServiceBrokers) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(servicebrokersResource, name), &servicecatalog.ServiceBroker{})
	return err
}
...
func (c *FakeServiceBrokers) Get(name string, options v1.GetOptions) (result *servicecatalog.ServiceBroker, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(servicebrokersResource, name), &servicecatalog.ServiceBroker{})
	if obj == nil {
		return nil, err
	}
	return obj.(*servicecatalog.ServiceBroker), err
...
func (c *FakeServiceBrokers) List(opts v1.ListOptions) (result *servicecatalog.ServiceBrokerList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(servicebrokersResource, servicebrokersKind, opts), &servicecatalog.ServiceBrokerList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeServiceBrokers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *servicecatalog.ServiceBroker, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(servicebrokersResource, name, data, subresources...), &servicecatalog.ServiceBroker{})
	if obj == nil {
		return nil, err
	}
	return obj.(*servicecatalog.ServiceBroker), err
