...
echo 'export OPENSHIFTCONFIG=/openshift.local.certificates/admin/.kubeconfig' >> /root/.bash_profile
echo 'export OPENSHIFTCONFIG=/openshift.local.certificates/admin/.kubeconfig' >> /home/vagrant/.bash_profile
