...
func (m *OAuthAccessToken) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x50
	i++
	i = encodeVarintGenerated(dAtA, i, uint64(m.TimeoutsIn))
	return i, nil
}
...
func (m *OAuthClient) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AccessTokenTimeoutSeconds != nil {
		dAtA[i] = 0x48
		i++
		i = encodeVarintGenerated(dAtA, i, uint64(*m.AccessTokenTimeoutSeconds))
	}
	return i, nil
}
...
func (m *OAuthAccessToken) Size() (n int) {
	...
	n += 1 + l + sovGenerated(uint64(l))
	n += 1 + sovGenerated(uint64(m.TimeoutsIn))
	return n
}
...
func (m *OAuthClient) Size() (n int) {
	...
	if m.AccessTokenTimeoutSeconds != nil {
		n += 1 + sovGenerated(uint64(*m.AccessTokenTimeoutSeconds))
	}
	return n
}
...
func (this *OAuthAccessToken) String() string {
	...
	s := strings.Join([]string{`&OAuthAccessToken{`,
		...
		`TimeoutsIn:` + fmt.Sprintf("%v", this.TimeoutsIn) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *OAuthClient) String() string {
	...
	s := strings.Join([]string{`&OAuthClient{`,
		...
		`AccessTokenTimeoutSeconds:` + valueToStringGenerated(this.AccessTokenTimeoutSeconds) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *OAuthAccessToken) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TimeoutsIn", wireType)
			}
			m.TimeoutsIn = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TimeoutsIn |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *OAuthClient) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AccessTokenTimeoutSeconds", wireType)
			}
			var v int32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorGenerated = []byte{
	...
	,
}
