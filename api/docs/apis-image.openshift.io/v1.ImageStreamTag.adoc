...
[[Post-apis-image.openshift.io-v1-namespaces-namespace-imagestreamtags-name-instantiate]]
=== Create instantiate of a ImageStreamTag in a namespace
Create instantiate of an ImageStreamTagInstantiate

==== HTTP request
----
POST /apis/image.openshift.io/v1/namespaces/$NAMESPACE/imagestreamtags/$NAME/instantiate HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
{
  "kind": "ImageStreamTagInstantiate",
  "apiVersion": "image.openshift.io/v1",
  ...
}
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/image.openshift.io/v1/namespaces/$NAMESPACE/imagestreamtags/$NAME/instantiate <<'EOF'
{
  "kind": "ImageStreamTagInstantiate",
  "apiVersion": "image.openshift.io/v1",
  ...
...
|===
|Parameter|Schema
|body|v1.ImageStreamTagInstantiate
|===
...
|===
|Parameter|Description
|name|name of the ImageStreamTagInstantiate
|namespace|object name and auth scope, such as for teams and projects
|===
...
|===
|HTTP Code|Schema
|200 OK|v1.ImageStreamTagInstantiate
|401 Unauthorized|
|===
...
[[Post-apis-image.openshift.io-v1-namespaces-namespace-imagestreamtags-name-instantiatelayer]]
=== Create instantiatelayer of a ImageStreamTag in a namespace
Connect POST requests to instantiatelayer of ImageStreamTagInstantiateOptions

==== HTTP request
----
POST /apis/image.openshift.io/v1/namespaces/$NAMESPACE/imagestreamtags/$NAME/instantiatelayer HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    ...
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/image.openshift.io/v1/namespaces/$NAMESPACE/imagestreamtags/$NAME/instantiatelayer
----
...
|===
|Parameter|Description
|name|name of the ImageStreamTagInstantiateOptions
|namespace|object name and auth scope, such as for teams and projects
|===
