...
</div></details><details open><summary><span title="(v1alpha1.AccessRestrictionSpec) Spec defines when this restriction is imposed and how to satisfy it.">spec</span>:
</summary><details><summary>  <span title="(array) The whitelist of subjects that are allowed to perform the actions defined by MatchAttributes. This list has priority over DeniedSubjects.  Thus DeniedSubjects is ignored if the subject exists in this list. Note that this only prevents a denial due to the access restriction. The subject must still have a matching RBAC binding to actually perform the current action. Optional.">allowedSubjects</span>:
</summary><details><summary>  - <span title="(v1.GroupRestriction) GroupRestriction matches against group subjects. Use system:serviceaccount:NAMESPACE to target all service accounts in a specific namespace. Use system:serviceaccounts to target all service accounts.">groupRestriction</span>:
...
</div></details></details></details><details><summary>    <span title="(v1.UserRestriction) UserRestriction matches against user or service account subjects. Use system:serviceaccount:NAMESPACE:NAME to target a specific service account.">userRestriction</span>:
...
</div></details></details></details><details><summary>  <span title="(array) The blacklist of subjects that are not allowed to perform the actions defined by MatchAttributes. AllowedSubjects has priority over this list.  It is ignored if the subject exists in AllowedSubjects. This restriction is processed before all RBAC data, and thus will reject actions that RBAC may otherwise permit. Required.">deniedSubjects</span>:
</summary><details><summary>  - <span title="(v1.GroupRestriction) GroupRestriction matches against group subjects. Use system:serviceaccount:NAMESPACE to target all service accounts in a specific namespace. Use system:serviceaccounts to target all service accounts.">groupRestriction</span>:
</summary><details><summary>  -   <span title="(array) Groups is a list of groups used to match against an individual user&#39;s groups. If the user is a member of one of the whitelisted groups, the user is allowed to be bound to a role.">groups</span>:
</summary><div style="margin-left:13px;">  -   - <span title="(string)">[string]</span>:
</div></details><details><summary>      <span title="(array) Selectors specifies a list of label selectors over group labels.">labels</span>:
...
</div></details></details></details><details><summary>  <span title="(array) If these rules cover the current request, then this restriction applies. If AllowedSubjects is set, those subjects can perform the matching actions even if they exist in DeniedSubjects. The subjects in DeniedSubjects are restricted from performing the matching actions unless they exist in AllowedSubjects. If the subject does not exist in either AllowedSubjects or DeniedSubjects, then this authorizer has no opinion on the request. Required.">matchAttributes</span>:
...
[[Post-apis-authorization.openshift.io-v1alpha1-accessrestrictions]]
=== Create a AccessRestriction
Create an AccessRestriction

==== HTTP request
----
POST /apis/authorization.openshift.io/v1alpha1/accessrestrictions HTTP/1.1
...
{
  "kind": "AccessRestriction",
  "apiVersion": "authorization.openshift.io/v1alpha1",
  ...
}
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/authorization.openshift.io/v1alpha1/accessrestrictions <<'EOF'
{
  "kind": "AccessRestriction",
  "apiVersion": "authorization.openshift.io/v1alpha1",
  ...
...
|===
|Parameter|Schema
|body|v1alpha1.AccessRestriction
|===
...
|===
|HTTP Code|Schema
|200 OK|v1alpha1.AccessRestriction
|201 Created|v1alpha1.AccessRestriction
|202 Accepted|v1alpha1.AccessRestriction
|401 Unauthorized|
|===
...
[[Get-apis-authorization.openshift.io-v1alpha1-accessrestrictions-name]]
=== Get a AccessRestriction
Read the specified AccessRestriction

==== HTTP request
----
GET /apis/authorization.openshift.io/v1alpha1/accessrestrictions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/authorization.openshift.io/v1alpha1/accessrestrictions/$NAME
----
...
|===
|Parameter|Description
|name|name of the AccessRestriction
|===
...
[[Get-apis-authorization.openshift.io-v1alpha1-accessrestrictions]]
=== Get all AccessRestrictions
List or watch objects of kind AccessRestriction

==== HTTP request
----
GET /apis/authorization.openshift.io/v1alpha1/accessrestrictions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/authorization.openshift.io/v1alpha1/accessrestrictions
----
...
|===
|HTTP Code|Schema
|200 OK|v1alpha1.AccessRestrictionList
|401 Unauthorized|
|===
...
[[Get-apis-authorization.openshift.io-v1alpha1-watch-accessrestrictions-name]]
=== Watch a AccessRestriction
Watch changes to an object of kind AccessRestriction

==== HTTP request
----
GET /apis/authorization.openshift.io/v1alpha1/watch/accessrestrictions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/authorization.openshift.io/v1alpha1/watch/accessrestrictions/$NAME
----
...
[[Get-apis-authorization.openshift.io-v1alpha1-watch-accessrestrictions]]
=== Watch all AccessRestrictions
Watch individual changes to a list of AccessRestriction

==== HTTP request
----
GET /apis/authorization.openshift.io/v1alpha1/watch/accessrestrictions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/authorization.openshift.io/v1alpha1/watch/accessrestrictions
----
...
[[Put-apis-authorization.openshift.io-v1alpha1-accessrestrictions-name]]
=== Update a AccessRestriction
Replace the specified AccessRestriction

==== HTTP request
----
PUT /apis/authorization.openshift.io/v1alpha1/accessrestrictions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/authorization.openshift.io/v1alpha1/accessrestrictions/$NAME <<'EOF'
{
  "kind": "AccessRestriction",
  "apiVersion": "authorization.openshift.io/v1alpha1",
  ...
...
[[Patch-apis-authorization.openshift.io-v1alpha1-accessrestrictions-name]]
=== Patch a AccessRestriction
Partially update the specified AccessRestriction

==== HTTP request
----
PATCH /apis/authorization.openshift.io/v1alpha1/accessrestrictions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
[[Delete-apis-authorization.openshift.io-v1alpha1-accessrestrictions-name]]
=== Delete a AccessRestriction
Delete an AccessRestriction

==== HTTP request
----
DELETE /apis/authorization.openshift.io/v1alpha1/accessrestrictions/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
[[Delete-apis-authorization.openshift.io-v1alpha1-accessrestrictions]]
=== Delete all AccessRestrictions
Delete collection of AccessRestriction

==== HTTP request
----
DELETE /apis/authorization.openshift.io/v1alpha1/accessrestrictions HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
