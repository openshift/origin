...
</div></details><details><summary>    <span title="(array) configs represents a list of configmaps and their destinations that will be used for the build.">configs</span>:
...
</div><details><summary>      <span title="(array) Configs is a list of additional configMaps that will be included in the custom build pod">configs</span>:
