...
[[Post-apis-rbac.authorization.k8s.io-v1-roles]]
=== Create a Role
Create a Role

==== HTTP request
----
POST /apis/rbac.authorization.k8s.io/v1/roles HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/roles <<'EOF'
{
  "kind": "Role",
  "apiVersion": "rbac.authorization.k8s.io/v1",
  ...
