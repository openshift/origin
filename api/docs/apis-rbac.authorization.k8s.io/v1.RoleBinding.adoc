...
</div></details><details><summary><span title="(v1.RoleRef) RoleRef can reference a Role in the current namespace or a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.">roleRef</span>:
...
[[Post-apis-rbac.authorization.k8s.io-v1-rolebindings]]
=== Create a RoleBinding
Create a RoleBinding

==== HTTP request
----
POST /apis/rbac.authorization.k8s.io/v1/rolebindings HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/rolebindings <<'EOF'
{
  "kind": "RoleBinding",
  "apiVersion": "rbac.authorization.k8s.io/v1",
  ...
...
==== HTTP request
----
POST /apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/rolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/rolebindings <<'EOF'
{
  "kind": "RoleBinding",
  "apiVersion": "rbac.authorization.k8s.io/v1",
  ...
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/rolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/rolebindings/$NAME
----
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1/rolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/rolebindings
----
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/rolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/rolebindings
----
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1/watch/namespaces/$NAMESPACE/rolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/watch/namespaces/$NAMESPACE/rolebindings/$NAME
----
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1/watch/rolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/watch/rolebindings
----
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1/watch/namespaces/$NAMESPACE/rolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/watch/namespaces/$NAMESPACE/rolebindings
----
...
==== HTTP request
----
PUT /apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/rolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/rolebindings/$NAME <<'EOF'
{
  "kind": "RoleBinding",
  "apiVersion": "rbac.authorization.k8s.io/v1",
  ...
...
==== HTTP request
----
PATCH /apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/rolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/rolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/rolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
