...
</div><div style="margin-left:13px;">  <span title="(integer) currentReplicas is the number of Pods created by the StatefulSet controller from the StatefulSet version indicated by currentRevision.">currentReplicas</span>:
