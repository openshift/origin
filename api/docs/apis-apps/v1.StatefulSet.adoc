...
</div></details><details open><summary><span title="(v1.StatefulSetSpec) Spec defines the desired identities of pods in this set.">spec</span>:
...
</div></details></details></details></details><details><summary>  <span title="(v1.StatefulSetUpdateStrategy) updateStrategy indicates the StatefulSetUpdateStrategy that will be employed to update Pods in the StatefulSet when a revision is made to Template.">updateStrategy</span>:
</summary><details><summary>    <span title="(v1.RollingUpdateStatefulSetStrategy) RollingUpdate is used to communicate parameters when Type is RollingUpdateStatefulSetStrategyType.">rollingUpdate</span>:
...
</div></details></details></details><details><summary><span title="(v1.StatefulSetStatus) Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.">status</span>:
...
[[Post-apis-apps-v1-statefulsets]]
=== Create a StatefulSet
Create a StatefulSet

==== HTTP request
----
POST /apis/apps/v1/statefulsets HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/apps/v1/statefulsets <<'EOF'
{
  "kind": "StatefulSet",
  "apiVersion": "apps/v1",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1.StatefulSet
|201 Created|v1.StatefulSet
|202 Accepted|v1.StatefulSet
|401 Unauthorized|
|===
...
==== HTTP request
----
POST /apis/apps/v1/namespaces/$NAMESPACE/statefulsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/statefulsets <<'EOF'
{
  "kind": "StatefulSet",
  "apiVersion": "apps/v1",
  ...
...
==== HTTP request
----
GET /apis/apps/v1/namespaces/$NAMESPACE/statefulsets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/statefulsets/$NAME
----
...
==== HTTP request
----
GET /apis/apps/v1/statefulsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/statefulsets
----
...
==== HTTP request
----
GET /apis/apps/v1/namespaces/$NAMESPACE/statefulsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/statefulsets
----
...
==== HTTP request
----
GET /apis/apps/v1/watch/namespaces/$NAMESPACE/statefulsets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/watch/namespaces/$NAMESPACE/statefulsets/$NAME
----
...
==== HTTP request
----
GET /apis/apps/v1/watch/statefulsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/watch/statefulsets
----
...
==== HTTP request
----
GET /apis/apps/v1/watch/namespaces/$NAMESPACE/statefulsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/watch/namespaces/$NAMESPACE/statefulsets
----
...
==== HTTP request
----
PUT /apis/apps/v1/namespaces/$NAMESPACE/statefulsets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/statefulsets/$NAME <<'EOF'
{
  "kind": "StatefulSet",
  "apiVersion": "apps/v1",
  ...
...
==== HTTP request
----
PATCH /apis/apps/v1/namespaces/$NAMESPACE/statefulsets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/apps/v1/namespaces/$NAMESPACE/statefulsets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/apps/v1/namespaces/$NAMESPACE/statefulsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
==== HTTP request
----
GET /apis/apps/v1/namespaces/$NAMESPACE/statefulsets/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/statefulsets/$NAME/scale
----
...
==== HTTP request
----
PUT /apis/apps/v1/namespaces/$NAMESPACE/statefulsets/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/statefulsets/$NAME/scale <<'EOF'
{
  "kind": "Scale",
  "apiVersion": "autoscaling/v1",
  ...
...
==== HTTP request
----
PATCH /apis/apps/v1/namespaces/$NAMESPACE/statefulsets/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json-patch+json'
...
==== HTTP request
----
GET /apis/apps/v1/namespaces/$NAMESPACE/statefulsets/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/statefulsets/$NAME/status
----
...
==== HTTP request
----
PUT /apis/apps/v1/namespaces/$NAMESPACE/statefulsets/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/statefulsets/$NAME/status <<'EOF'
{
  "kind": "StatefulSet",
  "apiVersion": "apps/v1",
  ...
...
==== HTTP request
----
PATCH /apis/apps/v1/namespaces/$NAMESPACE/statefulsets/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json-patch+json'
