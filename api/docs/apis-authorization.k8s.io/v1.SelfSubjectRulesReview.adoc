...
</div></details><details><summary>    <span title="(array) Resources is a list of resources this rule applies to.  ResourceAll represents all resources.  &#34;*&#34; means all.">resources</span>:
</summary><div style="margin-left:13px;">    - <span title="(string)">[string]</span>:
