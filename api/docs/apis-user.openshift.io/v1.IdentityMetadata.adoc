...
</div><div style="margin-left:13px;"><span title="(integer) ExpiresIn is the seconds from CreationTime before this identityMetadata expires.">expiresIn</span>:
...
</div></details><details><summary><span title="(array) ProviderGroups is the groups asserted by the provider for this OAuth flow.">providerGroups</span>:
</summary><div style="margin-left:13px;">- <span title="(string)">[string]</span>:
...
[[Post-apis-user.openshift.io-v1-identitymetadatas]]
=== Create a IdentityMetadata
Create an IdentityMetadata

==== HTTP request
----
POST /apis/user.openshift.io/v1/identitymetadatas HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/user.openshift.io/v1/identitymetadatas <<'EOF'
{
  "kind": "IdentityMetadata",
  "apiVersion": "user.openshift.io/v1",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1.IdentityMetadata
|201 Created|v1.IdentityMetadata
|202 Accepted|v1.IdentityMetadata
|401 Unauthorized|
|===
...
[[Get-apis-user.openshift.io-v1-identitymetadatas-name]]
=== Get a IdentityMetadata
Read the specified IdentityMetadata

==== HTTP request
----
GET /apis/user.openshift.io/v1/identitymetadatas/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/user.openshift.io/v1/identitymetadatas/$NAME
----
...
|===
|Parameter|Description
|name|name of the IdentityMetadata
|===
...
[[Get-apis-user.openshift.io-v1-identitymetadatas]]
=== Get all IdentityMetadatas
List or watch objects of kind IdentityMetadata

==== HTTP request
----
GET /apis/user.openshift.io/v1/identitymetadatas HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/user.openshift.io/v1/identitymetadatas
----
...
|===
|HTTP Code|Schema
|200 OK|v1.IdentityMetadataList
|401 Unauthorized|
|===
...
[[Get-apis-user.openshift.io-v1-watch-identitymetadatas-name]]
=== Watch a IdentityMetadata
Watch changes to an object of kind IdentityMetadata

==== HTTP request
----
GET /apis/user.openshift.io/v1/watch/identitymetadatas/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/user.openshift.io/v1/watch/identitymetadatas/$NAME
----
...
[[Get-apis-user.openshift.io-v1-watch-identitymetadatas]]
=== Watch all IdentityMetadatas
Watch individual changes to a list of IdentityMetadata

==== HTTP request
----
GET /apis/user.openshift.io/v1/watch/identitymetadatas HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/user.openshift.io/v1/watch/identitymetadatas
----
...
[[Put-apis-user.openshift.io-v1-identitymetadatas-name]]
=== Update a IdentityMetadata
Replace the specified IdentityMetadata

==== HTTP request
----
PUT /apis/user.openshift.io/v1/identitymetadatas/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/user.openshift.io/v1/identitymetadatas/$NAME <<'EOF'
{
  "kind": "IdentityMetadata",
  "apiVersion": "user.openshift.io/v1",
  ...
...
[[Patch-apis-user.openshift.io-v1-identitymetadatas-name]]
=== Patch a IdentityMetadata
Partially update the specified IdentityMetadata

==== HTTP request
----
PATCH /apis/user.openshift.io/v1/identitymetadatas/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
[[Delete-apis-user.openshift.io-v1-identitymetadatas-name]]
=== Delete a IdentityMetadata
Delete an IdentityMetadata

==== HTTP request
----
DELETE /apis/user.openshift.io/v1/identitymetadatas/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
[[Delete-apis-user.openshift.io-v1-identitymetadatas]]
=== Delete all IdentityMetadatas
Delete collection of IdentityMetadata

==== HTTP request
----
DELETE /apis/user.openshift.io/v1/identitymetadatas HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
