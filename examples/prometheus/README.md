...
$ oc create role hostaccessSCCUser --verb=use --resource=securitycontextcontraints.security.openshift.io --resourcename=hostaccess'
$ oc adm policy add-role-to-user hostaccessSCCUser -z prometheus-node-exporter -n kube-system hostaccess
