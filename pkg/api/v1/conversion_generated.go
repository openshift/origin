...
func convert_api_HostPortRange_To_v1_HostPortRange(in *policyapi.HostPortRange, out *policyapiv1.HostPortRange, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_api_PodSecurityPolicy_To_v1_PodSecurityPolicy(in *policyapi.PodSecurityPolicy, out *policyapiv1.PodSecurityPolicy, s conversion.Scope) error {
	...
	if err := convert_api_PodSecurityPolicySpec_To_v1_PodSecurityPolicySpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	return nil
}
...
func convert_api_PodSecurityPolicySpec_To_v1_PodSecurityPolicySpec(in *policyapi.PodSecurityPolicySpec, out *policyapiv1.PodSecurityPolicySpec, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
	...
	if in.Capabilities != nil {
		...
		for i := range in.Capabilities {
			out.Capabilities[i] = pkgapiv1.Capability(in.Capabilities[i])
		}
	} else {
		out.Capabilities = nil
	}
	if err := convert_api_VolumeSecurityPolicy_To_v1_VolumeSecurityPolicy(&in.Volumes, &out.Volumes, s); err != nil {
		return err
	}
	...
	if in.HostPorts != nil {
		...
		for i := range in.HostPorts {
			if err := convert_api_HostPortRange_To_v1_HostPortRange(&in.HostPorts[i], &out.HostPorts[i], s); err != nil {
				return err
			}
		}
	} else {
...
func convert_api_RunAsUserStrategyOptions_To_v1_RunAsUserStrategyOptions(in *policyapi.RunAsUserStrategyOptions, out *policyapiv1.RunAsUserStrategyOptions, s conversion.Scope) error {
	...
	out.Type = policyapiv1.RunAsUserStrategy(in.Type)
	if in.UID != nil {
		out.UID = new(int64)
		*out.UID = *in.UID
	} else {
...
func convert_api_SELinuxContextStrategyOptions_To_v1_SELinuxContextStrategyOptions(in *policyapi.SELinuxContextStrategyOptions, out *policyapiv1.SELinuxContextStrategyOptions, s conversion.Scope) error {
	...
	out.Type = policyapiv1.SELinuxContextStrategy(in.Type)
...
func convert_api_SecurityContextConstraints_To_v1_SecurityContextConstraints(in *policyapi.SecurityContextConstraints, out *policyapiv1.SecurityContextConstraints, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_api_SecurityContextConstraintsList_To_v1_SecurityContextConstraintsList(in *policyapi.SecurityContextConstraintsList, out *policyapiv1.SecurityContextConstraintsList, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_api_VolumeSecurityPolicy_To_v1_VolumeSecurityPolicy(in *policyapi.VolumeSecurityPolicy, out *policyapiv1.VolumeSecurityPolicy, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func convert_v1_HostPortRange_To_api_HostPortRange(in *policyapiv1.HostPortRange, out *policyapi.HostPortRange, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
		defaulting.(func(*policyapiv1.HostPortRange))(in)
	}
	out.Start = in.Start
	out.End = in.End
	return nil
...
func convert_v1_PodSecurityPolicy_To_api_PodSecurityPolicy(in *policyapiv1.PodSecurityPolicy, out *policyapi.PodSecurityPolicy, s conversion.Scope) error {
	...
	if err := convert_v1_PodSecurityPolicySpec_To_api_PodSecurityPolicySpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	return nil
}
...
func convert_v1_PodSecurityPolicySpec_To_api_PodSecurityPolicySpec(in *policyapiv1.PodSecurityPolicySpec, out *policyapi.PodSecurityPolicySpec, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
		defaulting.(func(*policyapiv1.PodSecurityPolicySpec))(in)
	}
	out.Privileged = in.Privileged
	if in.Capabilities != nil {
	...
	if err := convert_v1_VolumeSecurityPolicy_To_api_VolumeSecurityPolicy(&in.Volumes, &out.Volumes, s); err != nil {
		return err
	}
	out.HostNetwork = in.HostNetwork
	if in.HostPorts != nil {
		...
		for i := range in.HostPorts {
			if err := convert_v1_HostPortRange_To_api_HostPortRange(&in.HostPorts[i], &out.HostPorts[i], s); err != nil {
				return err
			}
		}
	} else {
...
func convert_v1_SecurityContextConstraints_To_api_SecurityContextConstraints(in *policyapiv1.SecurityContextConstraints, out *policyapi.SecurityContextConstraints, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
		defaulting.(func(*policyapiv1.SecurityContextConstraints))(in)
	}
	if err := convert_v1_TypeMeta_To_api_TypeMeta(&in.TypeMeta, &out.TypeMeta, s); err != nil {
		return err
	}
...
func convert_v1_SecurityContextConstraintsList_To_api_SecurityContextConstraintsList(in *policyapiv1.SecurityContextConstraintsList, out *policyapi.SecurityContextConstraintsList, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
		defaulting.(func(*policyapiv1.SecurityContextConstraintsList))(in)
	}
	if err := convert_v1_TypeMeta_To_api_TypeMeta(&in.TypeMeta, &out.TypeMeta, s); err != nil {
		return err
	}
...
func convert_v1_VolumeSecurityPolicy_To_api_VolumeSecurityPolicy(in *policyapiv1.VolumeSecurityPolicy, out *policyapi.VolumeSecurityPolicy, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
		defaulting.(func(*policyapiv1.VolumeSecurityPolicy))(in)
	}
	out.HostPath = in.HostPath
	out.EmptyDir = in.EmptyDir
	out.GCEPersistentDisk = in.GCEPersistentDisk
...
func init() {
	err := pkgapi.Scheme.AddGeneratedConversionFuncs(
		...
		convert_api_HostPortRange_To_v1_HostPortRange,
		...
		convert_api_PodSecurityPolicySpec_To_v1_PodSecurityPolicySpec,
		...
		convert_api_VolumeSecurityPolicy_To_v1_VolumeSecurityPolicy,
		...
		convert_v1_HostPortRange_To_api_HostPortRange,
		...
		convert_v1_PodSecurityPolicySpec_To_api_PodSecurityPolicySpec,
		...
		convert_v1_VolumeSecurityPolicy_To_api_VolumeSecurityPolicy,
