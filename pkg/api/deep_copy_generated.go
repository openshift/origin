...
func deepCopy_api_ImageStreamDeletion(in imageapi.ImageStreamDeletion, out *imageapi.ImageStreamDeletion, c *conversion.Cloner) error {
	if newVal, err := c.DeepCopy(in.TypeMeta); err != nil {
		return err
	} else {
		out.TypeMeta = newVal.(pkgapi.TypeMeta)
...
func deepCopy_api_ImageStreamDeletionList(in imageapi.ImageStreamDeletionList, out *imageapi.ImageStreamDeletionList, c *conversion.Cloner) error {
	if newVal, err := c.DeepCopy(in.TypeMeta); err != nil {
		return err
	} else {
		out.TypeMeta = newVal.(pkgapi.TypeMeta)
	...
	if in.Items != nil {
		...
		for i := range in.Items {
			if err := deepCopy_api_ImageStreamDeletion(in.Items[i], &out.Items[i], c); err != nil {
				return err
			}
		}
	} else {
...
func deepCopy_api_ImageStreamImageList(in imageapi.ImageStreamImageList, out *imageapi.ImageStreamImageList, c *conversion.Cloner) error {
	if newVal, err := c.DeepCopy(in.TypeMeta); err != nil {
		return err
	} else {
		out.TypeMeta = newVal.(pkgapi.TypeMeta)
	...
	if in.Items != nil {
		...
		for i := range in.Items {
			if err := deepCopy_api_ImageStreamImage(in.Items[i], &out.Items[i], c); err != nil {
				return err
			}
		}
	} else {
...
func init() {
	err := pkgapi.Scheme.AddGeneratedDeepCopyFuncs(
		...
		deepCopy_api_ImageStreamImageList,
