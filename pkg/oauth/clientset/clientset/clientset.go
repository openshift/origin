...
import (
	...
	oauthv1 "github.com/openshift/origin/pkg/oauth/clientset/clientset/typed/oauth/v1"
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.OauthV1Client, err = oauthv1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.OauthV1Client = oauthv1.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.OauthV1Client = oauthv1.New(c)
