...
type Interface interface {
	...
	OauthV1() v1oauth.OauthV1Interface
	// Deprecated: please explicitly pick a version if possible.
	Oauth() v1oauth.OauthV1Interface
}
...
func NewForConfig(c *restclient.Config) (*Clientset, error) {
	...
	var err error
	clientset.OauthV1Client, err = v1oauth.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *restclient.Config) *Clientset {
	var clientset Clientset
	clientset.OauthV1Client = v1oauth.NewForConfigOrDie(c)
...
func New(c restclient.Interface) *Clientset {
	var clientset Clientset
	clientset.OauthV1Client = v1oauth.New(c)
