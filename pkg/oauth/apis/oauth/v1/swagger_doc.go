...
var map_OAuthAccessToken = map[string]string{
	...
	"identityName":           "IdentityName is the name of the Identity API object associated with this token",
	"identityProviderGroups": "IdentityProviderGroups are the group memberships determined by the identity provider",
}
