...
func (m *OAuthAccessToken) MarshalTo(data []byte) (int, error) {
	...
	data[i] = 0x5a
	i++
	i = encodeVarintGenerated(data, i, uint64(len(m.Salt)))
	i += copy(data[i:], m.Salt)
	data[i] = 0x62
	i++
	i = encodeVarintGenerated(data, i, uint64(len(m.SaltedHash)))
	i += copy(data[i:], m.SaltedHash)
	return i, nil
}
...
func (this *OAuthAccessToken) String() string {
	...
	s := strings.Join([]string{`&OAuthAccessToken{`,
		...
		`SaltedHash:` + fmt.Sprintf("%v", this.SaltedHash) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *OAuthAccessToken) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SaltedHash", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SaltedHash = string(data[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGenerated(data[iNdEx:])
...
var fileDescriptorGenerated = []byte{
	...
	,
}
