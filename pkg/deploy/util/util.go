...
func DeploymentConditionExists(status deployapi.DeploymentConfigStatus, condType deployapi.DeploymentConditionType, condStatus api.ConditionStatus, condReason string) bool {
