...
func TestGetClosestP95Value(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedDuration: mustDuration("507.44s"),
			expectedDetails:  `(no exact match for historicaldata.DataKey{Name:"ingress-to-console-new-connections", JobType:platformidentification.JobType{Release:"4.11", FromRelease:"4.10", Platform:"aws", Network:"ovn", Topology:"single"}}, fell back to historicaldata.DataKey{Name:"ingress-to-console-new-connections", JobType:platformidentification.JobType{Release:"4.10", FromRelease:"4.10", Platform:"aws", Network:"sdn", Topology:"single"}})`,
		},
		{
			name: "missing",
			args: args{
