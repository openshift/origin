...
func TransformTemplate(tpl *templateapi.Template, client templateclient.TemplateInterface, namespace string, parameters map[string]string, ignoreUnknownParameters bool) (*templateapi.Template, error) {
	...
	result, err := processor.Process(tpl)
	if err != nil {
