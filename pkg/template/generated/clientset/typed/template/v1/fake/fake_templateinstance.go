...
func (c *FakeTemplateInstances) Get(name string, options v1.GetOptions) (result *template_v1.TemplateInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(templateinstancesResource, c.ns, name), &template_v1.TemplateInstance{})

	if obj == nil {
		return nil, err
	}
	return obj.(*template_v1.TemplateInstance), err
}

// List takes label and field selectors, and returns the list of TemplateInstances that match those selectors.
func (c *FakeTemplateInstances) List(opts v1.ListOptions) (result *template_v1.TemplateInstanceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(templateinstancesResource, templateinstancesKind, c.ns, opts), &template_v1.TemplateInstanceList{})
...
func (c *FakeTemplateInstances) Create(templateInstance *template_v1.TemplateInstance) (result *template_v1.TemplateInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(templateinstancesResource, c.ns, templateInstance), &template_v1.TemplateInstance{})
...
func (c *FakeTemplateInstances) Update(templateInstance *template_v1.TemplateInstance) (result *template_v1.TemplateInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(templateinstancesResource, c.ns, templateInstance), &template_v1.TemplateInstance{})
...
func (c *FakeTemplateInstances) UpdateStatus(templateInstance *template_v1.TemplateInstance) (*template_v1.TemplateInstance, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(templateinstancesResource, "status", c.ns, templateInstance), &template_v1.TemplateInstance{})
...
func (c *FakeTemplateInstances) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(templateinstancesResource, c.ns, name), &template_v1.TemplateInstance{})
...
func (c *FakeTemplateInstances) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &template_v1.TemplateInstanceList{})
	return err
}

// Patch applies the patch and returns the patched templateInstance.
func (c *FakeTemplateInstances) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *template_v1.TemplateInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(templateinstancesResource, c.ns, name, data, subresources...), &template_v1.TemplateInstance{})
