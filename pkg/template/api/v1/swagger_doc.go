...
var map_Parameter = map[string]string{
	...
	"presentationHint": "Optional: Defines the presentation style a UI should use when prompting a user for a value for this parameter, eg \"multiline\" or \"fileUpload\"",
}
