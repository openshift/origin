...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_template_ParameterizeTemplateRequest, InType: reflect.TypeOf(&ParameterizeTemplateRequest{})},
...
// DeepCopy_template_ParameterizeTemplateRequest is an autogenerated deepcopy function.
func DeepCopy_template_ParameterizeTemplateRequest(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*ParameterizeTemplateRequest)
		out := out.(*ParameterizeTemplateRequest)
		*out = *in
		if newVal, err := c.DeepCopy(&in.ObjectMeta); err != nil {
			return err
		} else {
		...
		if in.Aspects != nil {
			...
			*out = make([]ParameterizableAspect, len(*in))
			copy(*out, *in)
		}
		...
		*out = *in
		...
		if in.Requester != nil {
			...
			*out = new(TemplateInstanceRequester)
			if err := DeepCopy_template_TemplateInstanceRequester(*in, *out, c); err != nil {
				return err
			}
		}
		return nil
