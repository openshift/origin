...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_TemplateCompletion, InType: reflect.TypeOf(&TemplateCompletion{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_TemplateCompletionRequirement, InType: reflect.TypeOf(&TemplateCompletionRequirement{})},
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_TemplateInstanceObject, InType: reflect.TypeOf(&TemplateInstanceObject{})},
		...
		*out = *in
		...
		if in.Completion != nil {
			...
			*out = new(TemplateCompletion)
			if err := DeepCopy_v1_TemplateCompletion(*in, *out, c); err != nil {
				return err
			}
		}
		return nil
...
// DeepCopy_v1_TemplateCompletion is an autogenerated deepcopy function.
func DeepCopy_v1_TemplateCompletion(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		if in.Objects != nil {
			...
			*out = make([]TemplateInstanceObject, len(*in))
			for i := range *in {
				if err := DeepCopy_v1_TemplateInstanceObject(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
...
// DeepCopy_v1_TemplateCompletionRequirement is an autogenerated deepcopy function.
func DeepCopy_v1_TemplateCompletionRequirement(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		if in.SuccessRequirements != nil {
			...
			*out = make([]TemplateCompletionRequirement, len(*in))
			for i := range *in {
				if err := DeepCopy_v1_TemplateCompletionRequirement(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
