...
func (*TemplateCompletion) Descriptor() ([]byte, []int) { return fileDescriptorGenerated, []int{5} }

func (m *TemplateCompletionRequirement) Reset()      { *m = TemplateCompletionRequirement{} }
func (*TemplateCompletionRequirement) ProtoMessage() {}
func (*TemplateCompletionRequirement) Descriptor() ([]byte, []int) {
...
func init() {
	...
	proto.RegisterType((*TemplateCompletion)(nil), "github.com.openshift.origin.pkg.template.apis.template.v1.TemplateCompletion")
	proto.RegisterType((*TemplateCompletionRequirement)(nil), "github.com.openshift.origin.pkg.template.apis.template.v1.TemplateCompletionRequirement")
...
func (m *Template) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Completion != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintGenerated(dAtA, i, uint64(m.Completion.Size()))
		n7, err := m.Completion.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
func (m *TemplateCompletion) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x8
	i++
	i = encodeVarintGenerated(dAtA, i, uint64(m.DeadlineSeconds))
	if len(m.Objects) > 0 {
		for _, msg := range m.Objects {
			dAtA[i] = 0x12
			i++
...
func (m *TemplateCompletionRequirement) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TemplateCompletionRequirement) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *TemplateInstanceObject) MarshalTo(dAtA []byte) (int, error) {
	...
	i += n13
	if len(m.SuccessRequirements) > 0 {
		for _, msg := range m.SuccessRequirements {
			dAtA[i] = 0x12
			i++
			i = encodeVarintGenerated(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
	...
	if len(m.FailureRequirements) > 0 {
		for _, msg := range m.FailureRequirements {
			dAtA[i] = 0x1a
			i++
			i = encodeVarintGenerated(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *TemplateCompletion) Size() (n int) {
	var l int
	_ = l
	n += 1 + sovGenerated(uint64(m.DeadlineSeconds))
	if len(m.Objects) > 0 {
		for _, e := range m.Objects {
			l = e.Size()
			n += 1 + l + sovGenerated(uint64(l))
...
func (m *TemplateCompletionRequirement) Size() (n int) {
	var l int
	_ = l
	l = len(m.Type)
	n += 1 + l + sovGenerated(uint64(l))
...
func (m *TemplateInstanceObject) Size() (n int) {
	...
	n += 1 + l + sovGenerated(uint64(l))
	if len(m.SuccessRequirements) > 0 {
		for _, e := range m.SuccessRequirements {
			l = e.Size()
			n += 1 + l + sovGenerated(uint64(l))
		}
	}
	if len(m.FailureRequirements) > 0 {
		for _, e := range m.FailureRequirements {
			l = e.Size()
			n += 1 + l + sovGenerated(uint64(l))
		}
	}
...
func (this *Template) String() string {
	...
	s := strings.Join([]string{`&Template{`,
		...
		`Completion:` + strings.Replace(fmt.Sprintf("%v", this.Completion), "TemplateCompletion", "TemplateCompletion", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *TemplateCompletion) String() string {
	...
	s := strings.Join([]string{`&TemplateCompletion{`,
		`DeadlineSeconds:` + fmt.Sprintf("%v", this.DeadlineSeconds) + `,`,
		`Objects:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.Objects), "TemplateInstanceObject", "TemplateInstanceObject", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *TemplateCompletionRequirement) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&TemplateCompletionRequirement{`,
		`Type:` + fmt.Sprintf("%v", this.Type) + `,`,
		`JSONPath:` + valueToStringGenerated(this.JSONPath) + `,`,
...
func (this *TemplateInstanceObject) String() string {
	...
	s := strings.Join([]string{`&TemplateInstanceObject{`,
		...
		`SuccessRequirements:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.SuccessRequirements), "TemplateCompletionRequirement", "TemplateCompletionRequirement", 1), `&`, ``, 1) + `,`,
		`FailureRequirements:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.FailureRequirements), "TemplateCompletionRequirement", "TemplateCompletionRequirement", 1), `&`, ``, 1) + `,`,
...
func (m *Template) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.Completion == nil {
				m.Completion = &TemplateCompletion{}
			}
...
func (m *TemplateCompletion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeadlineSeconds", wireType)
			}
			m.DeadlineSeconds = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DeadlineSeconds |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *TemplateCompletionRequirement) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TemplateCompletionRequirement: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TemplateCompletionRequirement: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Type = TemplateCompletionRequirementType(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
func (m *TemplateInstanceObject) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SuccessRequirements", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SuccessRequirements = append(m.SuccessRequirements, TemplateCompletionRequirement{})
			if err := m.SuccessRequirements[len(m.SuccessRequirements)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FailureRequirements", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FailureRequirements = append(m.FailureRequirements, TemplateCompletionRequirement{})
			if err := m.FailureRequirements[len(m.FailureRequirements)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
...
var fileDescriptorGenerated = []byte{
	...
	,
}
