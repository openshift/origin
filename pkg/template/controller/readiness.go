...
func checkBuildReadiness(oc client.Interface, obj runtime.Object) (bool, bool, error) {
	...
	ready := buildutil.IsTerminalPhase(b.Status.Phase) && b.Status.Phase == buildapi.BuildPhaseComplete

	failed := buildutil.IsTerminalPhase(b.Status.Phase) && b.Status.Phase != buildapi.BuildPhaseComplete

	return ready, failed, nil
}

// TODO: this should be reported on the BuildConfig object itself.
...
// TODO: remove "oc client.Interface" and error once BuildConfigs can report on
// the status of their latest build
