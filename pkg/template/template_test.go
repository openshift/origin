...
func ExampleProcessTemplateParameters() {
	...
	// Output:
	// WARNING: Parameter processing failed: Parameter substitution not implemented for *api.Route
	// WARNING: Parameter processing failed: Parameter substitution not implemented for *api.Service
	// WARNING: Parameter processing failed: Parameter substitution not implemented for *api.Service
	// WARNING: Parameter processing failed: Parameter substitution not implemented for *api.Service
