...
func readTemplateFromFile(fname string) (*Template, error) {
	var template Template
	jsonData, _ := ioutil.ReadFile(fname)
...
func TestNewTemplate(t *testing.T) {
	var err error
	sampleTemplate, err = readTemplateFromFile("example/project.json")
	if err != nil {
...
func ExampleTransformTemplate() {
	...
	template, err := readTemplateFromFile("example/project.json")
	if err != nil {
	...
	TransformTemplate(resultTemplate, customParams)

	result, _ := json.Marshal(resultTemplate)
