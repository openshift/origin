...
func ValidateAppliedClusterResourceQuota(clusterquota *quotav1.AppliedClusterResourceQuota) field.ErrorList {
	return ValidateClusterResourceQuota(convertAppliedClusterResourceQuotaToClusterResourceQuota(clusterquota))
}

func ValidateAppliedClusterResourceQuotaUpdate(clusterquota, oldClusterResourceQuota *quotav1.AppliedClusterResourceQuota) field.ErrorList {
	return ValidateClusterResourceQuotaUpdate(
		convertAppliedClusterResourceQuotaToClusterResourceQuota(clusterquota),
		convertAppliedClusterResourceQuotaToClusterResourceQuota(oldClusterResourceQuota))
}
