...
func (clusterResourceQuotaV1) ValidateStatusUpdate(obj runtime.Object, oldObj runtime.Object) field.ErrorList {
	clusterResourceQuotaObj, errs := toClusterResourceQuota(obj)
	if len(errs) > 0 {
		return errs
	}
	...
	// TODO: We should probably validate the real status here?

	errs = append(errs, validation.ValidateObjectMetaUpdate(&clusterResourceQuotaObj.ObjectMeta, &clusterResourceQuotaOldObj.ObjectMeta, field.NewPath("metadata"))...)
	return errs
}
