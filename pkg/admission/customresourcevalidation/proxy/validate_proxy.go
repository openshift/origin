...
func Register(plugins *admission.Plugins) {
	plugins.Register("config.openshift.io/ValidateProxy", func(config io.Reader) (admission.Interface, error) {
...
func (proxyV1) ValidateStatusUpdate(uncastObj runtime.Object, uncastOldObj runtime.Object) field.ErrorList {
	obj, errs := toProxyV1(uncastObj)
	if len(errs) > 0 {
		return errs
	}
