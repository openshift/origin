...
func (c *FakeLocalSubjectAccessReviews) Create(localSubjectAccessReview *authorization.LocalSubjectAccessReview) (result *authorization.LocalSubjectAccessReview, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(localsubjectaccessreviewsResource, c.ns, localSubjectAccessReview), &authorization.LocalSubjectAccessReview{})

	if obj == nil {
		return nil, err
	}
	return obj.(*authorization.LocalSubjectAccessReview), err
}
