...
type Registry interface {
	...
	ListClusterPolicies(ctx kapi.Context, options *unversioned.ListOptions) (*authorizationapi.ClusterPolicyList, error)
...
type WatchingRegistry interface {
	...
	WatchClusterPolicies(ctx kapi.Context, options *unversioned.ListOptions) (watch.Interface, error)
}
...
func (s *storage) ListClusterPolicies(ctx kapi.Context, options *unversioned.ListOptions) (*authorizationapi.ClusterPolicyList, error) {
...
func (s *storage) WatchClusterPolicies(ctx kapi.Context, options *unversioned.ListOptions) (watch.Interface, error) {
...
func (s *simulatedStorage) ListPolicies(ctx kapi.Context, options *unversioned.ListOptions) (*authorizationapi.PolicyList, error) {
