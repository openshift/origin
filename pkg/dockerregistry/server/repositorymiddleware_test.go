...
func TestRepositoryBlobStat(t *testing.T) {
	...
	for _, d := range []struct {
		...
		etcdOnlyImages[d.name] = newImageForManifest(t, d.name, sampleImageManifestSchema1, d.managed)
	}
...
func newImageForManifest(t *testing.T, repoName string, rawManifest string, managedByOpenShift bool) *imageapi.Image {
