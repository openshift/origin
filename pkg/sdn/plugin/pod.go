...
func newPodManager(host knetwork.Host, localSubnetCIDR string, netInfo *NetworkInfo, kClient kclientset.Interface, policy osdnPolicy, mtu uint32, ovs *ovs.Interface) (*podManager, error) {
