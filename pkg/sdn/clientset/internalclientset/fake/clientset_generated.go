...
import (
	...
	fakeinternalversionsdn "github.com/openshift/origin/pkg/sdn/clientset/internalclientset/typed/sdn/internalversion/fake"
...
func (c *Clientset) Sdn() internalversionsdn.SdnInterface {
	return &fakeinternalversionsdn.FakeSdn{Fake: &c.Fake}
}
