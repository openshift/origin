...
// deployment.
func RecordConfigEvent(client corev1client.EventsGetter, deployment *corev1.ReplicationController, decoder runtime.Decoder, eventType, reason,
	msg string) {
...
func RecordConfigWarnings(client corev1client.EventsGetter, rc *corev1.ReplicationController, decoder runtime.Decoder, out io.Writer) {
	if rc == nil {
		return
	}
