...
func NewExecutionRulesAccepter(rules []api.ImageExecutionPolicyRule, integratedRegistryMatcher RegistryMatcher) Accepter {
...
func (r *executionAccepter) Accepts(attrs *ImagePolicyAttributes) bool {
	...
	for _, rule := range r.rules {
		...
		matches := matchSourceRule(&rule.ImageCondition, r.integratedRegistryMatcher, attrs)
