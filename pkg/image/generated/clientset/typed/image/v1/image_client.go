...
import (
	...
	"github.com/openshift/origin/pkg/image/generated/clientset/scheme"
...
func (c *ImageV1Client) ImageSignatures(namespace string) ImageSignatureInterface {
	return newImageSignatures(c, namespace)
}
