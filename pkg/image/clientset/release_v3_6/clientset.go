...
import (
	...
	imagev1 "github.com/openshift/origin/pkg/image/clientset/release_v3_6/typed/image/v1"
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.ImageV1Client, err = imagev1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.ImageV1Client = imagev1.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.ImageV1Client = imagev1.New(c)
