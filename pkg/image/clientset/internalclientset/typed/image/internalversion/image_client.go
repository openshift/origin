...
import (
	"github.com/openshift/origin/pkg/image/clientset/internalclientset/scheme"
...
func (c *ImageClient) ImageStreamImages() ImageStreamImageInterface {
	return newImageStreamImages(c)
}
