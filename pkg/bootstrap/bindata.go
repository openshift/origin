...
// sources:
// examples/image-streams/image-streams-centos7.yaml
// examples/image-streams/image-streams-rhel7.yaml
// examples/db-templates/mariadb-ephemeral-template.yaml
// examples/db-templates/mariadb-persistent-template.yaml
// examples/db-templates/mongodb-ephemeral-template.yaml
// examples/db-templates/mongodb-persistent-template.yaml
// examples/db-templates/mysql-ephemeral-template.yaml
// examples/db-templates/mysql-persistent-template.yaml
// examples/db-templates/postgresql-ephemeral-template.yaml
// examples/db-templates/postgresql-persistent-template.yaml
// examples/db-templates/redis-ephemeral-template.yaml
// examples/db-templates/redis-persistent-template.yaml
// examples/jenkins/jenkins-ephemeral-template.yaml
// examples/jenkins/jenkins-persistent-template.yaml
...
// examples/quickstarts/cakephp-mysql.yaml
// examples/quickstarts/dancer-mysql.yaml
// examples/quickstarts/django-postgresql.yaml
// examples/quickstarts/nodejs-mongodb.yaml
// examples/quickstarts/rails-postgresql.yaml
...
var _examplesImageStreamsImageStreamsCentos7Yaml = []byte(`---
  ...
  spec:
    ...
    - name: '0.10'
      annotations:
        ...
        description: Build and run Node.js 0.10 applications on CentOS 7. For more
  ...
  spec:
    ...
    - name: '8.1'
      annotations:
        ...
        description: Build and run WildFly 8.1 applications on CentOS 7. For more
          information about using this builder image, including OpenShift considerations,
    ...
    - name: '9.0'
      annotations:
        ...
        description: Build and run WildFly 9.0 applications on CentOS 7. For more
          information about using this builder image, including OpenShift considerations,
          see https://github.com/openshift-s2i/s2i-wildfly/blob/master/README.md.
        iconClass: icon-wildfly
        tags: builder,wildfly,java
    ...
    - name: '10.0'
      annotations:
        ...
        description: Build and run WildFly 10.0 applications on CentOS 7. For more
          information about using this builder image, including OpenShift considerations,
          see https://github.com/openshift-s2i/s2i-wildfly/blob/master/README.md.
        iconClass: icon-wildfly
        tags: builder,wildfly,java
    ...
    - name: '10.1'
      annotations:
        ...
        description: Build and run WildFly 10.1 applications on CentOS 7. For more
          information about using this builder image, including OpenShift considerations,
          see https://github.com/openshift-s2i/s2i-wildfly/blob/master/README.md.
        iconClass: icon-wildfly
        tags: builder,wildfly,java
    ...
    - name: '9.2'
      annotations:
        ...
        description: Provides a PostgreSQL 9.2 database on CentOS 7. For more information
          about using this database image, including OpenShift considerations, see
          https://github.com/sclorg/postgresql-container/tree/master/9.2.
        iconClass: icon-postgresql
        tags: postgresql
        version: '9.2'
      from:
    ...
    - name: '9.4'
      annotations:
        ...
        description: Provides a PostgreSQL 9.4 database on CentOS 7. For more information
          about using this database image, including OpenShift considerations, see
          https://github.com/sclorg/postgresql-container/tree/master/9.4.
        iconClass: icon-postgresql
        tags: postgresql
        version: '9.4'
      from:
...
func examplesImageStreamsImageStreamsCentos7YamlBytes() ([]byte, error) {
	return _examplesImageStreamsImageStreamsCentos7Yaml, nil
}

func examplesImageStreamsImageStreamsCentos7Yaml() (*asset, error) {
	bytes, err := examplesImageStreamsImageStreamsCentos7YamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/image-streams/image-streams-centos7.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _examplesImageStreamsImageStreamsRhel7Yaml = []byte(`---
kind: ImageStreamList
apiVersion: v1
metadata: {}
items:
...
- kind: ImageStream
  ...
  spec:
    ...
    - name: '0.10'
      annotations:
        openshift.io/display-name: Node.js 0.10
        description: Build and run Node.js 0.10 applications on RHEL 7. For more information
          about using this builder image, including OpenShift considerations, see
  ...
  spec:
    ...
    - name: latest
      annotations:
        openshift.io/display-name: PHP (Latest)
        description: |-
          Build and run PHP applications on RHEL 7. For more information about using this builder image, including OpenShift considerations, see https://github.com/sclorg/s2i-php-container/blob/master/5.6/README.md.
...
func examplesImageStreamsImageStreamsRhel7YamlBytes() ([]byte, error) {
	return _examplesImageStreamsImageStreamsRhel7Yaml, nil
}

func examplesImageStreamsImageStreamsRhel7Yaml() (*asset, error) {
	bytes, err := examplesImageStreamsImageStreamsRhel7YamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/image-streams/image-streams-rhel7.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _examplesDbTemplatesMariadbEphemeralTemplateYaml = []byte(`---
kind: Template
apiVersion: v1
metadata:
...
func examplesDbTemplatesMariadbEphemeralTemplateYamlBytes() ([]byte, error) {
	return _examplesDbTemplatesMariadbEphemeralTemplateYaml, nil
}

func examplesDbTemplatesMariadbEphemeralTemplateYaml() (*asset, error) {
	bytes, err := examplesDbTemplatesMariadbEphemeralTemplateYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/db-templates/mariadb-ephemeral-template.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _examplesDbTemplatesMariadbPersistentTemplateYaml = []byte(`---
kind: Template
apiVersion: v1
metadata:
...
func examplesDbTemplatesMariadbPersistentTemplateYamlBytes() ([]byte, error) {
	return _examplesDbTemplatesMariadbPersistentTemplateYaml, nil
}

func examplesDbTemplatesMariadbPersistentTemplateYaml() (*asset, error) {
	bytes, err := examplesDbTemplatesMariadbPersistentTemplateYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/db-templates/mariadb-persistent-template.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _examplesDbTemplatesMongodbEphemeralTemplateYaml = []byte(`---
kind: Template
apiVersion: v1
metadata:
...
func examplesDbTemplatesMongodbEphemeralTemplateYamlBytes() ([]byte, error) {
	return _examplesDbTemplatesMongodbEphemeralTemplateYaml, nil
}

func examplesDbTemplatesMongodbEphemeralTemplateYaml() (*asset, error) {
	bytes, err := examplesDbTemplatesMongodbEphemeralTemplateYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/db-templates/mongodb-ephemeral-template.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _examplesDbTemplatesMysqlEphemeralTemplateYaml = []byte(`---
kind: Template
apiVersion: v1
metadata:
...
func examplesDbTemplatesMysqlEphemeralTemplateYamlBytes() ([]byte, error) {
	return _examplesDbTemplatesMysqlEphemeralTemplateYaml, nil
}

func examplesDbTemplatesMysqlEphemeralTemplateYaml() (*asset, error) {
	bytes, err := examplesDbTemplatesMysqlEphemeralTemplateYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/db-templates/mysql-ephemeral-template.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _examplesDbTemplatesMysqlPersistentTemplateYaml = []byte(`---
kind: Template
apiVersion: v1
metadata:
  ...
  annotations:
    ...
    description: |-
      MySQL database service, with persistent storage. For more information about using this template, including OpenShift considerations, see https://github.com/sclorg/mysql-container/blob/master/5.6/README.md.
...
func examplesDbTemplatesMysqlPersistentTemplateYamlBytes() ([]byte, error) {
	return _examplesDbTemplatesMysqlPersistentTemplateYaml, nil
}

func examplesDbTemplatesMysqlPersistentTemplateYaml() (*asset, error) {
	bytes, err := examplesDbTemplatesMysqlPersistentTemplateYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/db-templates/mysql-persistent-template.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _examplesDbTemplatesPostgresqlEphemeralTemplateYaml = []byte(`---
kind: Template
apiVersion: v1
metadata:
...
func examplesDbTemplatesPostgresqlEphemeralTemplateYamlBytes() ([]byte, error) {
	return _examplesDbTemplatesPostgresqlEphemeralTemplateYaml, nil
}

func examplesDbTemplatesPostgresqlEphemeralTemplateYaml() (*asset, error) {
	bytes, err := examplesDbTemplatesPostgresqlEphemeralTemplateYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/db-templates/postgresql-ephemeral-template.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _examplesDbTemplatesPostgresqlPersistentTemplateYaml = []byte(`---
kind: Template
apiVersion: v1
metadata:
...
func examplesDbTemplatesPostgresqlPersistentTemplateYamlBytes() ([]byte, error) {
	return _examplesDbTemplatesPostgresqlPersistentTemplateYaml, nil
}

func examplesDbTemplatesPostgresqlPersistentTemplateYaml() (*asset, error) {
	bytes, err := examplesDbTemplatesPostgresqlPersistentTemplateYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/db-templates/postgresql-persistent-template.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _examplesDbTemplatesRedisEphemeralTemplateYaml = []byte(`---
kind: Template
apiVersion: v1
metadata:
...
func examplesDbTemplatesRedisEphemeralTemplateYamlBytes() ([]byte, error) {
	return _examplesDbTemplatesRedisEphemeralTemplateYaml, nil
}

func examplesDbTemplatesRedisEphemeralTemplateYaml() (*asset, error) {
	bytes, err := examplesDbTemplatesRedisEphemeralTemplateYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/db-templates/redis-ephemeral-template.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _examplesDbTemplatesRedisPersistentTemplateYaml = []byte(`---
kind: Template
apiVersion: v1
metadata:
...
func examplesDbTemplatesRedisPersistentTemplateYamlBytes() ([]byte, error) {
	return _examplesDbTemplatesRedisPersistentTemplateYaml, nil
}

func examplesDbTemplatesRedisPersistentTemplateYaml() (*asset, error) {
	bytes, err := examplesDbTemplatesRedisPersistentTemplateYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/db-templates/redis-persistent-template.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _examplesJenkinsJenkinsEphemeralTemplateYaml = []byte(`---
kind: Template
apiVersion: v1
metadata:
...
func examplesJenkinsJenkinsEphemeralTemplateYamlBytes() ([]byte, error) {
	return _examplesJenkinsJenkinsEphemeralTemplateYaml, nil
}

func examplesJenkinsJenkinsEphemeralTemplateYaml() (*asset, error) {
	bytes, err := examplesJenkinsJenkinsEphemeralTemplateYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/jenkins/jenkins-ephemeral-template.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _examplesJenkinsJenkinsPersistentTemplateYaml = []byte(`---
kind: Template
apiVersion: v1
metadata:
...
func examplesJenkinsJenkinsPersistentTemplateYamlBytes() ([]byte, error) {
	return _examplesJenkinsJenkinsPersistentTemplateYaml, nil
}

func examplesJenkinsJenkinsPersistentTemplateYaml() (*asset, error) {
	bytes, err := examplesJenkinsJenkinsPersistentTemplateYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/jenkins/jenkins-persistent-template.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _examplesJenkinsPipelineBluegreenPipelineYaml = []byte(`---
apiVersion: v1
kind: Template
labels:
...
var _examplesJenkinsPipelineMapsappPipelineYaml = []byte(`---
apiVersion: v1
kind: Template
labels:
...
var _examplesJenkinsPipelineMavenPipelineYaml = []byte(`---
apiVersion: v1
kind: Template
metadata:
  name: maven-pipeline
...
var _examplesJenkinsPipelineSamplepipelineYaml = []byte(`---
apiVersion: v1
kind: Template
labels:
...
var _examplesQuickstartsCakephpMysqlYaml = []byte(`---
kind: Template
apiVersion: v1
metadata:
...
func examplesQuickstartsCakephpMysqlYamlBytes() ([]byte, error) {
	return _examplesQuickstartsCakephpMysqlYaml, nil
}

func examplesQuickstartsCakephpMysqlYaml() (*asset, error) {
	bytes, err := examplesQuickstartsCakephpMysqlYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/quickstarts/cakephp-mysql.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _examplesQuickstartsDancerMysqlYaml = []byte(`---
kind: Template
apiVersion: v1
metadata:
...
func examplesQuickstartsDancerMysqlYamlBytes() ([]byte, error) {
	return _examplesQuickstartsDancerMysqlYaml, nil
}

func examplesQuickstartsDancerMysqlYaml() (*asset, error) {
	bytes, err := examplesQuickstartsDancerMysqlYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/quickstarts/dancer-mysql.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _examplesQuickstartsDjangoPostgresqlYaml = []byte(`---
kind: Template
apiVersion: v1
metadata:
...
func examplesQuickstartsDjangoPostgresqlYamlBytes() ([]byte, error) {
	return _examplesQuickstartsDjangoPostgresqlYaml, nil
}

func examplesQuickstartsDjangoPostgresqlYaml() (*asset, error) {
	bytes, err := examplesQuickstartsDjangoPostgresqlYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/quickstarts/django-postgresql.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _examplesQuickstartsNodejsMongodbYaml = []byte(`---
kind: Template
apiVersion: v1
metadata:
  name: nodejs-mongodb-example
...
func examplesQuickstartsNodejsMongodbYamlBytes() ([]byte, error) {
	return _examplesQuickstartsNodejsMongodbYaml, nil
}

func examplesQuickstartsNodejsMongodbYaml() (*asset, error) {
	bytes, err := examplesQuickstartsNodejsMongodbYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/quickstarts/nodejs-mongodb.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _examplesQuickstartsRailsPostgresqlYaml = []byte(`---
kind: Template
apiVersion: v1
metadata:
...
func examplesQuickstartsRailsPostgresqlYamlBytes() ([]byte, error) {
	return _examplesQuickstartsRailsPostgresqlYaml, nil
}

func examplesQuickstartsRailsPostgresqlYaml() (*asset, error) {
	bytes, err := examplesQuickstartsRailsPostgresqlYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "examples/quickstarts/rails-postgresql.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _examplesLoggingLoggingDeployerYaml = []byte(`---
apiVersion: "v1"
kind: "List"
items:
-
...
var _bindata = map[string]func() (*asset, error){
	"examples/image-streams/image-streams-centos7.yaml": examplesImageStreamsImageStreamsCentos7Yaml,
	"examples/image-streams/image-streams-rhel7.yaml": examplesImageStreamsImageStreamsRhel7Yaml,
	"examples/db-templates/mariadb-ephemeral-template.yaml": examplesDbTemplatesMariadbEphemeralTemplateYaml,
	"examples/db-templates/mariadb-persistent-template.yaml": examplesDbTemplatesMariadbPersistentTemplateYaml,
	"examples/db-templates/mongodb-ephemeral-template.yaml": examplesDbTemplatesMongodbEphemeralTemplateYaml,
	"examples/db-templates/mongodb-persistent-template.yaml": examplesDbTemplatesMongodbPersistentTemplateYaml,
	"examples/db-templates/mysql-ephemeral-template.yaml": examplesDbTemplatesMysqlEphemeralTemplateYaml,
	"examples/db-templates/mysql-persistent-template.yaml": examplesDbTemplatesMysqlPersistentTemplateYaml,
	"examples/db-templates/postgresql-ephemeral-template.yaml": examplesDbTemplatesPostgresqlEphemeralTemplateYaml,
	"examples/db-templates/postgresql-persistent-template.yaml": examplesDbTemplatesPostgresqlPersistentTemplateYaml,
	"examples/db-templates/redis-ephemeral-template.yaml": examplesDbTemplatesRedisEphemeralTemplateYaml,
	"examples/db-templates/redis-persistent-template.yaml": examplesDbTemplatesRedisPersistentTemplateYaml,
	"examples/jenkins/jenkins-ephemeral-template.yaml": examplesJenkinsJenkinsEphemeralTemplateYaml,
	"examples/jenkins/jenkins-persistent-template.yaml": examplesJenkinsJenkinsPersistentTemplateYaml,
	...
	"examples/quickstarts/cakephp-mysql.yaml": examplesQuickstartsCakephpMysqlYaml,
	"examples/quickstarts/dancer-mysql.yaml": examplesQuickstartsDancerMysqlYaml,
	"examples/quickstarts/django-postgresql.yaml": examplesQuickstartsDjangoPostgresqlYaml,
	"examples/quickstarts/nodejs-mongodb.yaml": examplesQuickstartsNodejsMongodbYaml,
	"examples/quickstarts/rails-postgresql.yaml": examplesQuickstartsRailsPostgresqlYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"examples": &bintree{nil, map[string]*bintree{
		"db-templates": &bintree{nil, map[string]*bintree{
			"mariadb-ephemeral-template.yaml": &bintree{examplesDbTemplatesMariadbEphemeralTemplateYaml, map[string]*bintree{}},
			"mariadb-persistent-template.yaml": &bintree{examplesDbTemplatesMariadbPersistentTemplateYaml, map[string]*bintree{}},
			"mongodb-ephemeral-template.yaml": &bintree{examplesDbTemplatesMongodbEphemeralTemplateYaml, map[string]*bintree{}},
			"mongodb-persistent-template.yaml": &bintree{examplesDbTemplatesMongodbPersistentTemplateYaml, map[string]*bintree{}},
			"mysql-ephemeral-template.yaml": &bintree{examplesDbTemplatesMysqlEphemeralTemplateYaml, map[string]*bintree{}},
			"mysql-persistent-template.yaml": &bintree{examplesDbTemplatesMysqlPersistentTemplateYaml, map[string]*bintree{}},
			"postgresql-ephemeral-template.yaml": &bintree{examplesDbTemplatesPostgresqlEphemeralTemplateYaml, map[string]*bintree{}},
			"postgresql-persistent-template.yaml": &bintree{examplesDbTemplatesPostgresqlPersistentTemplateYaml, map[string]*bintree{}},
			"redis-ephemeral-template.yaml": &bintree{examplesDbTemplatesRedisEphemeralTemplateYaml, map[string]*bintree{}},
			"redis-persistent-template.yaml": &bintree{examplesDbTemplatesRedisPersistentTemplateYaml, map[string]*bintree{}},
		}},
		"image-streams": &bintree{nil, map[string]*bintree{
			"image-streams-centos7.yaml": &bintree{examplesImageStreamsImageStreamsCentos7Yaml, map[string]*bintree{}},
			"image-streams-rhel7.yaml": &bintree{examplesImageStreamsImageStreamsRhel7Yaml, map[string]*bintree{}},
		}},
		"jenkins": &bintree{nil, map[string]*bintree{
			"jenkins-ephemeral-template.yaml": &bintree{examplesJenkinsJenkinsEphemeralTemplateYaml, map[string]*bintree{}},
			"jenkins-persistent-template.yaml": &bintree{examplesJenkinsJenkinsPersistentTemplateYaml, map[string]*bintree{}},
		...
		"quickstarts": &bintree{nil, map[string]*bintree{
			"cakephp-mysql.yaml": &bintree{examplesQuickstartsCakephpMysqlYaml, map[string]*bintree{}},
			"dancer-mysql.yaml": &bintree{examplesQuickstartsDancerMysqlYaml, map[string]*bintree{}},
			"django-postgresql.yaml": &bintree{examplesQuickstartsDjangoPostgresqlYaml, map[string]*bintree{}},
			"nodejs-mongodb.yaml": &bintree{examplesQuickstartsNodejsMongodbYaml, map[string]*bintree{}},
			"rails-postgresql.yaml": &bintree{examplesQuickstartsRailsPostgresqlYaml, map[string]*bintree{}},
		}},
	}},
