...
type Registry interface {
	...
	ListRoutes(ctx kapi.Context, options *metainternal.ListOptions) (*api.RouteList, error)
	...
	WatchRoutes(ctx kapi.Context, options *metainternal.ListOptions) (watch.Interface, error)
}
