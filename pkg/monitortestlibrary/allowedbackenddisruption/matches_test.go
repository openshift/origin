...
func TestDisruptionDataFileParsing(t *testing.T) {
	...
	assert.NotEqual(t, percentiles, historicaldata.StatisticalDuration{}, "BestMatchDuration found no match and could not fall back for kube-api-new-connections azure amd64 ovn ha")
