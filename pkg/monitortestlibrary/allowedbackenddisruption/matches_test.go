...
func TestDisruptionDataFileParsing(t *testing.T) {
	...
	percentiles, details, err := disruptionMatcher.BestMatchDuration("kube-api-new-connections", jobType, 100)
	...
	assert.NotEqual(t, percentiles, historicaldata.StatisticalDuration{}, "BestMatchDuration found no match and could not fall back: %s", details)
