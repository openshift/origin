...
func setConfigDefaults(config *rest.Config) error {
	...
	if config.GroupVersion == nil || config.GroupVersion.Group != scheme.Scheme.PrioritizedVersionsForGroup("quota.openshift.io")[0].Group {
		gv := scheme.Scheme.PrioritizedVersionsForGroup("quota.openshift.io")[0]
