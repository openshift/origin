...
const (
	...
	ServingCertSecretAnnotation = "service.openshift.io/serving-cert-secret-name"
	...
	// regeneration
	ServingCertCreatedByAnnotation = "service.openshift.io/serving-cert-signed-by"
	// ServingCertErrorAnnotation stores the error that caused cert generation failures.
	ServingCertErrorAnnotation = "service.openshift.io/serving-cert-generation-error"
	...
	ServingCertErrorNumAnnotation = "service.openshift.io/serving-cert-generation-error-num"
	// ServiceUIDAnnotation is an annotation on a secret that indicates which service created it, by UID
	ServiceUIDAnnotation = "service.openshift.io/originating-service-uid"
	...
	ServiceNameAnnotation = "service.openshift.io/originating-service-name"
	...
	ServingCertExpiryAnnotation = "service.openshift.io/expiry"
)
