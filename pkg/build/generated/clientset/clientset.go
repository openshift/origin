...
import (
	...
	buildv1 "github.com/openshift/origin/pkg/build/generated/clientset/typed/build/v1"
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.BuildV1Client, err = buildv1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.BuildV1Client = buildv1.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.BuildV1Client = buildv1.New(c)
