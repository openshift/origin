...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1_ConfigSpec_To_build_ConfigSpec,
		Convert_build_ConfigSpec_To_v1_ConfigSpec,
...
func autoConvert_v1_ConfigSpec_To_build_ConfigSpec(in *v1.ConfigSpec, out *build.ConfigSpec, s conversion.Scope) error {
	if err := core_v1.Convert_v1_LocalObjectReference_To_core_LocalObjectReference(&in.ConfigMapSource, &out.ConfigMapSource, s); err != nil {
		return err
	}
...
// Convert_v1_ConfigSpec_To_build_ConfigSpec is an autogenerated conversion function.
func Convert_v1_ConfigSpec_To_build_ConfigSpec(in *v1.ConfigSpec, out *build.ConfigSpec, s conversion.Scope) error {
	return autoConvert_v1_ConfigSpec_To_build_ConfigSpec(in, out, s)
}

func autoConvert_build_ConfigSpec_To_v1_ConfigSpec(in *build.ConfigSpec, out *v1.ConfigSpec, s conversion.Scope) error {
	if err := core_v1.Convert_core_LocalObjectReference_To_v1_LocalObjectReference(&in.ConfigMapSource, &out.ConfigMapSource, s); err != nil {
		return err
	}
	out.MountPath = in.MountPath
	return nil
...
// Convert_build_ConfigSpec_To_v1_ConfigSpec is an autogenerated conversion function.
func Convert_build_ConfigSpec_To_v1_ConfigSpec(in *build.ConfigSpec, out *v1.ConfigSpec, s conversion.Scope) error {
	return autoConvert_build_ConfigSpec_To_v1_ConfigSpec(in, out, s)
}
...
func autoConvert_v1_CustomBuildStrategy_To_build_CustomBuildStrategy(in *v1.CustomBuildStrategy, out *build.CustomBuildStrategy, s conversion.Scope) error {
	...
	if in.Configs != nil {
		in, out := &in.Configs, &out.Configs
		*out = make([]build.ConfigSpec, len(*in))
		for i := range *in {
			if err := Convert_v1_ConfigSpec_To_build_ConfigSpec(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_build_CustomBuildStrategy_To_v1_CustomBuildStrategy(in *build.CustomBuildStrategy, out *v1.CustomBuildStrategy, s conversion.Scope) error {
	...
	if in.Configs != nil {
		in, out := &in.Configs, &out.Configs
		*out = make([]v1.ConfigSpec, len(*in))
		for i := range *in {
			if err := Convert_build_ConfigSpec_To_v1_ConfigSpec(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
