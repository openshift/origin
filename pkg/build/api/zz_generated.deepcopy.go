...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_BuildStepInfo, InType: reflect.TypeOf(&BuildStepInfo{})},
...
func DeepCopy_api_BuildStatus(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		if in.StepInfo != nil {
			...
			*out = make([]BuildStepInfo, len(*in))
			for i := range *in {
				if err := DeepCopy_api_BuildStepInfo(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		} else {
...
func DeepCopy_api_BuildStepInfo(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*BuildStepInfo)
