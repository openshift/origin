...
type BuildSpec struct {
	...
	// build. It is a slice to account for a future implementation
	// of level triggered builds when we could have multiples build
	// triggers that can trigger one build.
