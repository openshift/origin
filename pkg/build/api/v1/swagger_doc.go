...
var map_SourceBuildStrategy = map[string]string{
	...
	"forcePull":            "ForcePull describes if the builder should pull the images from registry prior to building.",
	"disableImplicitBuild": "disableImplicitBuild prevents source-to-image from performing a Docker build operation when one is needed to execute ONBUILD statements in the builder image, or because the builder image does not include a prereq such as \"sh\" or \"tar\"",
}
