...
import (
	...
	"github.com/openshift/origin/pkg/monitortests/apps/pdbunhealthypodevictionpolicy"
...
func newDefaultMonitorTests(info monitortestframework.MonitorTestInitializationInfo) monitortestframework.MonitorTestRegistry {
	...
	monitorTestRegistry.AddMonitorTestOrDie(etcddiskfsync.MonitorName, "etcd", etcddiskfsync.NewMonitorTest())
...
func newUniversalMonitorTests(info monitortestframework.MonitorTestInitializationInfo) monitortestframework.MonitorTestRegistry {
	...
	monitorTestRegistry.AddMonitorTestOrDie("pdb-unhealthy-pod-eviction-policy", "Cluster Version Operator", pdbunhealthypodevictionpolicy.NewAnalyzer())
