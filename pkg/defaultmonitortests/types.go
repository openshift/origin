...
import (
	...
	nodefaultserviceaccountoperatortests "github.com/openshift/origin/pkg/monitortests/authentication/nodefaultserviceaccountoperatorstests"
...
func newDefaultMonitorTests(info monitortestframework.MonitorTestInitializationInfo) monitortestframework.MonitorTestRegistry {
	...
	monitorTestRegistry.AddMonitorTestOrDie("no-default-service-account-operator-checker", "Operators", nodefaultserviceaccountoperatortests.NewAnalyzer())
