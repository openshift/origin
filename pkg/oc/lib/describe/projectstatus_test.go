	...
	testCases := map[string]struct {
		...
		"unstarted build": {
			...
			Contains: []string{
				...
				"on docker.io/centos/ruby-27-centos7:latest",
				"not built yet",
		...
		"cyclical build": {
			...
			Contains: []string{
				...
				"on istag/ruby-27-centos7:latest",
		...
		"with deployment": {
			...
			Contains: []string{
				...
				"bc/ruby-deploy source builds https://github.com/sclorg/ruby-ex.git on istag/ruby-27-centos7:latest",
				"not built yet",
			},
			Time: mustParseTime("2015-04-07T04:12:25Z"),
		},
