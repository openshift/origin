...
func RegisterTemplateServiceBroker(dockerClient dockerhelper.Interface, ocImage string, clusterAdminKubeConfig []byte, configDir string, logdir string) error {
