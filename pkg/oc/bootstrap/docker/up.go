...
func (c *ClientStartConfig) StartOpenShift(out io.Writer) error {
	...
	authClient, err := factory.OpenshiftInternalAuthorizationClient()
	if err != nil {
		return err
	}
	...
	err = c.OpenShiftHelper().SetupPersistentStorage(authClient.Authorization(), kClient, c.HostPersistentVolumesDir)
	if err != nil {
		return err
	}
	return nil
