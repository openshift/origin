...
func NewCommandCLI(name, fullName string, in io.Reader, out, errout io.Writer) *cobra.Command {
	...
	groups := ktemplates.CommandGroups{
		...
		},
		{
			...
			Commands: []*cobra.Command{
				admin.NewCommandAdmin("adm", fullName+" "+"adm", ioStreams),
	...
	cmds.AddCommand(newExperimentalCommand("ex", name+"ex", ioStreams))
...
func newExperimentalCommand(name, fullName string, ioStreams genericclioptions.IOStreams) *cobra.Command {
	...
	deprecatedDiag := diagnostics.NewCmdDiagnostics(diagnostics.DiagnosticsRecommendedName, fullName+" "+diagnostics.DiagnosticsRecommendedName, ioStreams)
