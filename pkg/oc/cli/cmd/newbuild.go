...
func NewCmdNewBuild(name, baseName string, f *clientcmd.Factory, streams genericclioptions.IOStreams) *cobra.Command {
...
func (o *BuildOptions) Complete(baseName, commandName string, f *clientcmd.Factory, cmd *cobra.Command, args []string) error {
