...
func NewCmdCreateEdgeRoute(fullName string, f *clientcmd.Factory, streams genericclioptions.IOStreams) *cobra.Command {
...
func (o *CreateEdgeRouteOptions) Complete(f *clientcmd.Factory, cmd *cobra.Command, args []string) error {
