...
func NewCmdCreateImageStream(name, fullName string, f *clientcmd.Factory, streams genericclioptions.IOStreams) *cobra.Command {
...
func (o *CreateImageStreamOptions) Run() error {
	...
	if !o.DryRun {
		var err error
		imageStream, err = o.Client.ImageStreams(o.Namespace).Create(imageStream)
		if err != nil {
			return err
		}
	}

	return o.PrintObj(imageStream)
}
