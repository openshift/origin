...
func NewCmdCreatePassthroughRoute(fullName string, f *clientcmd.Factory, streams genericclioptions.IOStreams) *cobra.Command {
...
func (o *CreatePassthroughRouteOptions) Complete(f *clientcmd.Factory, cmd *cobra.Command, args []string) error {
