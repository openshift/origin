...
func NewCmdSet(fullName string, f *clientcmd.Factory, streams genericclioptions.IOStreams) *cobra.Command {
	set := &cobra.Command{
		Use:   "set COMMAND",
	...
	groups := ktemplates.CommandGroups{
		{
			...
			Commands: []*cobra.Command{
				NewCmdEnv(name, f, streams.In, streams.Out, streams.ErrOut),
...
func NewCmdImage(fullName string, f *clientcmd.Factory, streams genericclioptions.IOStreams) *cobra.Command {
	cmd := set.NewCmdImage(f, streams.Out, streams.ErrOut)
...
func NewCmdResources(fullName string, f *clientcmd.Factory, streams genericclioptions.IOStreams) *cobra.Command {
	cmd := set.NewCmdResources(f, streams.Out, streams.ErrOut)
