...
func NewCmdImageLookup(fullName, parentName string, f *clientcmd.Factory, streams genericclioptions.IOStreams) *cobra.Command {
...
func (o *ImageLookupOptions) printImageLookup(infos []*oldresource.Info) error {
