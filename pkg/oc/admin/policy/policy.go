...
type LocalRoleBindingAccessor struct {
	...
	Client           authorizationclient.AuthorizationInterface
}

func NewLocalRoleBindingAccessor(bindingNamespace string, client authorizationclient.AuthorizationInterface) LocalRoleBindingAccessor {
...
func NewClusterRoleBindingAccessor(client authorizationclient.AuthorizationInterface) ClusterRoleBindingAccessor {
