...
import (
	clientset "github.com/openshift/origin/pkg/user/clientset/clientset"
	userv1 "github.com/openshift/origin/pkg/user/clientset/clientset/typed/user/v1"
	fakeuserv1 "github.com/openshift/origin/pkg/user/clientset/clientset/typed/user/v1/fake"
