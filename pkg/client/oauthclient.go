...
func (c *oauthClients) List(opts metainternal.ListOptions) (result *oauthapi.OAuthClientList, err error) {
...
func (c *oauthClients) Watch(opts metainternal.ListOptions) (watch.Interface, error) {
