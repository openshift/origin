...
func (*TcpProtocolOptions) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{0} }
...
func (*Http1ProtocolOptions) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{1} }
...
func (*Http2ProtocolOptions) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{2} }
...
func (*GrpcProtocolOptions) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{3} }
...
func init() { proto.RegisterFile("api/protocol.proto", fileDescriptor11) }
