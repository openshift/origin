...
func (*DataSource) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{0} }
...
func (*TlsParameters) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{1} }
...
func (*TlsCertificate) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{2} }
...
func (*TlsSessionTicketKeys) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{3} }
...
func (*CertificateValidationContext) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{4} }
...
func (*CommonTlsContext) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{5} }
...
func (*UpstreamTlsContext) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{6} }
...
func (*DownstreamTlsContext) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{7} }
...
func (*SdsSecretConfig) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{8} }
...
func (*Secret) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{9} }
...
func init() { proto.RegisterFile("api/sds.proto", fileDescriptor14) }
