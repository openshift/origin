...
func (RateLimitResponse_Code) EnumDescriptor() ([]byte, []int) { return fileDescriptor13, []int{2, 0} }
...
func (RateLimitResponse_RateLimit_Unit) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor13, []int{2, 0, 0}
}
...
func (*RateLimitRequest) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{0} }
...
func (*RateLimitDescriptor) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{1} }
...
func (*RateLimitDescriptor_Entry) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{1, 0} }
...
func (*RateLimitResponse) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{2} }
...
func (*RateLimitResponse_RateLimit) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{2, 0} }
...
func init() { proto.RegisterFile("api/rls.proto", fileDescriptor13) }
