...
type Factory struct {
	...
	Describe func(*cobra.Command, *meta.RESTMapping) (kubectl.DescribeFunc, error)
...
func NewFactory() *Factory {
	return &Factory{
		...
		Describe: func(cmd *cobra.Command, mapping *meta.RESTMapping) (kubectl.DescribeFunc, error) {
			return nil, nil
		},
		Printer: func(cmd *cobra.Command, mapping *meta.RESTMapping, noHeaders bool) (kubectl.ResourcePrinter, error) {
