...
import (
	...
	"github.com/openshift/origin/pkg/project/generated/clientset/scheme"
...
func (c *ProjectV1Client) ProjectReservations() ProjectReservationInterface {
	return newProjectReservations(c)
}
