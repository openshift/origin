...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_ProjectReservation, InType: reflect.TypeOf(&ProjectReservation{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_ProjectReservationList, InType: reflect.TypeOf(&ProjectReservationList{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_ProjectReservationSpec, InType: reflect.TypeOf(&ProjectReservationSpec{})},
...
// DeepCopy_v1_ProjectReservation is an autogenerated deepcopy function.
func DeepCopy_v1_ProjectReservation(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
...
// DeepCopy_v1_ProjectReservationList is an autogenerated deepcopy function.
func DeepCopy_v1_ProjectReservationList(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		if in.Items != nil {
			...
			*out = make([]ProjectReservation, len(*in))
			for i := range *in {
				if err := DeepCopy_v1_ProjectReservation(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
...
// DeepCopy_v1_ProjectReservationSpec is an autogenerated deepcopy function.
func DeepCopy_v1_ProjectReservationSpec(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
