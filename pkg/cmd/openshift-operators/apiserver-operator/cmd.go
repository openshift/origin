...
import (
	...
	"github.com/openshift/origin/pkg/cmd/openshift-operators/apiserver-operator/controller"
	"github.com/openshift/origin/pkg/cmd/server/origin"
)

const (
	RecommendedAPIServerOperatorName = "openshift-apiserver-operator"
)
...
func NewAPIServerOperatorCommand(name string, out, errout io.Writer) *cobra.Command {
	options := &APIServerOperator{Output: out}
	...
	cmd := &cobra.Command{
		...
		Run: func(c *cobra.Command, args []string) {
			...
			if err := options.RunAPIServerOperator(); err != nil {
...
func (o *APIServerOperator) Validate() error {
	return nil
}

func (o *APIServerOperator) RunAPIServerOperator() error {
	...
	operator := &controller.APIServerOperatorStarter{
	...
	rl, err := resourcelock.New(
		...
		RecommendedAPIServerOperatorName,
		kubeClient.CoreV1(),
