...
type WebconsoleV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*WebconsoleV1alpha1Client, error) {
	...
	return &WebconsoleV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new WebconsoleV1alpha1Client for the given config and
...
func New(c rest.Interface) *WebconsoleV1alpha1Client {
	return &WebconsoleV1alpha1Client{c}
}
