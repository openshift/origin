...
func TestModifyNamedClusterRoleBinding(t *testing.T) {
	...
	for tcName, tc := range tests {
		...
		o := &policy.RoleModificationOptions{
			...
			RoleBindingAccessor: policy.NewClusterRoleBindingAccessor(authfake.NewSimpleClientset(tc.existingClusterRoleBindings).Authorization()),
		}
...
func TestModifyNamedLocalRoleBinding(t *testing.T) {
	...
	for tcName, tc := range tests {
		...
		o := &policy.RoleModificationOptions{
			...
			RoleBindingAccessor: policy.NewLocalRoleBindingAccessor(metav1.NamespaceDefault, authfake.NewSimpleClientset(tc.existingRoleBindings).Authorization()),
		}
