...
type EtcdStorageConfig struct {
	...
	Encrypt StorageEncryption `json:"encrypt"`
}
...
type StorageEncryption struct {
	...
	Keys []StorageEncryptionKey `json:"keys"`

	// The list of group resources that will be encrypted.
	GroupResources []GroupResource `json:"groupResources"`
}
...
type StorageEncryptionKey struct {
	...
	AESGCM *AESGCMStorageEncryption `json:"aesgcm"`
}
