...
type UserAgentMatchRule struct {
	...
	// 5. oc adm accessing kube resources: oc adm/v1.2.0 (linux/amd64) kubernetes/bc4550d
	// 6. oc adm accessing openshift resources: oc adm/v1.1.3 (linux/amd64) openshift/b348c2f
