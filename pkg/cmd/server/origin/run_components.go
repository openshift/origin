...
func (c *MasterConfig) RunServiceServingCertController(client *kClientsetInternal.Clientset) {
...
func (c *MasterConfig) RunIngressIPController(client *kClientsetInternal.Clientset) {
