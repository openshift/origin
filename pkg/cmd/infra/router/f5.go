...
func (o *F5RouterOptions) Run() error {
	...
	plugin := controller.NewHostAdmitter(statusPlugin, o.F5RouteAdmitterFunc(), o.RouteSelectionFunc(), false, o.RouterSelection.DisableNamespaceOwnershipCheck, statusPlugin)
