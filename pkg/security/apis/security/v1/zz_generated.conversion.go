...
func autoConvert_v1_AllowedFlexVolume_To_security_AllowedFlexVolume(in *AllowedFlexVolume, out *security.AllowedFlexVolume, s conversion.Scope) error {
	out.Driver = in.Driver
	return nil
}

// Convert_v1_AllowedFlexVolume_To_security_AllowedFlexVolume is an autogenerated conversion function.
func Convert_v1_AllowedFlexVolume_To_security_AllowedFlexVolume(in *AllowedFlexVolume, out *security.AllowedFlexVolume, s conversion.Scope) error {
	return autoConvert_v1_AllowedFlexVolume_To_security_AllowedFlexVolume(in, out, s)
}

func autoConvert_security_AllowedFlexVolume_To_v1_AllowedFlexVolume(in *security.AllowedFlexVolume, out *AllowedFlexVolume, s conversion.Scope) error {
	out.Driver = in.Driver
	return nil
}

// Convert_security_AllowedFlexVolume_To_v1_AllowedFlexVolume is an autogenerated conversion function.
func Convert_security_AllowedFlexVolume_To_v1_AllowedFlexVolume(in *security.AllowedFlexVolume, out *AllowedFlexVolume, s conversion.Scope) error {
