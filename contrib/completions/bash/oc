...
_oc_adm_migrate_authorization()
{
    last_command="oc_adm_migrate_authorization"
    commands=()
...
_oc_adm_migrate_volumesource()
{
    last_command="oc_adm_migrate_volumesource"
    commands=()
...
_oc_annotate()
{
    ...
    must_have_one_noun+=("brokertemplateinstance")
    ...
    noun_aliases+=("brokertemplateinstances")
...
_oc_cluster_join()
{
    ...
    flags+=("--service-catalog")
    local_nonpersistent_flags+=("--service-catalog")
