...
6 Enable the ones we’ll be using
--------------------------------
[source,bash]
-----------------------------------------
...
12 Setup SSH environment (for ansible)
--------------------------------------
[source,bash]
----------------------------------
ssh-keygen
...
15 run oc get nodes (things should be up now)
---------------------------------------------
...
16 Create sample app (from the training example earlier)
--------------------------------------------------------
