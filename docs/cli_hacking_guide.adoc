...
*** https://github.com/openshift/origin/tree/master/pkg/cmd/infra/builder[pkg/cmd/infra/builder] - `openshift-sti-build`, `openshift-docker-build`, and `openshift-git-clone` commands.
