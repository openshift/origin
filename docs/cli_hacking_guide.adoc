...
Cli test cases can be written either in shell or golang. The tests using shell are present in test/cmd directory. 
...
os::cmd::try_until_success
os::cmd::expect_success
os::cmd::expect_failure
os::cmd::expect_failure_and_text
For detailed usage, please look at test/cmd/
