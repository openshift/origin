...
*** https://github.com/openshift/origin/tree/master/pkg/cmd/infra/builder[pkg/cmd/infra/builder] - `openshift-sti-build`, `openshift-docker-build`, `openshift-git-clone`, `openshift-extract-image-content`, and `openshift-manage-dockerfile` commands.
