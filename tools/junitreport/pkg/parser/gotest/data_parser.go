...
// ExtractSuite extracts the name of the test suite from a test output line
func ExtractSuite(line string) (name string, duration string, coverage string, ok bool) {
