...
func ExtractConfigFrom(config *imageregistryv1.Config, fieldManager string, subresource string) (*ConfigApplyConfiguration, error) {
	b := &ConfigApplyConfiguration{}
...
func (b *ConfigApplyConfiguration) WithSpec(value *ImageRegistrySpecApplyConfiguration) *ConfigApplyConfiguration {
	b.Spec = value
	return b
}
...
func (b *ConfigApplyConfiguration) WithStatus(value *ImageRegistryStatusApplyConfiguration) *ConfigApplyConfiguration {
	b.Status = value
	return b
}
