...
func (b *ConsoleYAMLSampleApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *ConsoleYAMLSampleApplyConfiguration) GetAPIVersion() *string {
...
func (b *ConsoleYAMLSampleApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
