...
func (c *FakeTemplates) Create(template *template_v1.Template) (result *template_v1.Template, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(templatesResource, c.ns, template), &template_v1.Template{})
...
func (c *FakeTemplates) Update(template *template_v1.Template) (result *template_v1.Template, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(templatesResource, c.ns, template), &template_v1.Template{})
