...
func (b *ServiceCatalogControllerManagerApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *ServiceCatalogControllerManagerApplyConfiguration) GetAPIVersion() *string {
...
func (b *ServiceCatalogControllerManagerApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
