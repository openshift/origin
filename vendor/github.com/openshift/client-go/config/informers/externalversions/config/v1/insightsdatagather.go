...
type InsightsDataGatherIndexInformer cache.TypedSharedIndexInformer[*apiconfigv1.InsightsDataGather]

// InsightsDataGatherHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for InsightsDataGather.
type InsightsDataGatherHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apiconfigv1.InsightsDataGather]
...
type InsightsDataGatherDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apiconfigv1.InsightsDataGather]
...
type InsightsDataGatherFilteringHandler = cache.TypedFilteringResourceEventHandler[*apiconfigv1.InsightsDataGather]

// InsightsDataGatherIndexers is a specialization of [cache.TypedIndexers] for InsightsDataGather.
type InsightsDataGatherIndexers = cache.TypedIndexers[*apiconfigv1.InsightsDataGather]

// DeletedInsightsDataGather is a specialization of [cache.DeletedObject] for InsightsDataGather.
type DeletedInsightsDataGather = cache.DeletedObject[*apiconfigv1.InsightsDataGather]
...
func NewTypedInsightsDataGatherInformerWithOptions(client versioned.Interface, options internalinterfaces.InformerOptions) InsightsDataGatherIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiconfigv1.InsightsDataGather](cache.NewSharedIndexInformerWithOptions(
...
func (f *insightsDataGatherInformer) TypedInformer() InsightsDataGatherIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiconfigv1.InsightsDataGather](f.factory.InformerFor(&apiconfigv1.InsightsDataGather{}, f.defaultInformer))
}
...
func (a *insightsDataGatherTypedInformerAdapter) TypedInformer() InsightsDataGatherIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiconfigv1.InsightsDataGather](a.Informer())
}
...
func ToInsightsDataGatherIndexInformer(informer cache.SharedIndexInformer) InsightsDataGatherIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiconfigv1.InsightsDataGather](informer)
}
