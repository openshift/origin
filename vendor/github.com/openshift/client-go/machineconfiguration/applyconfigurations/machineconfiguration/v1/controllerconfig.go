...
// ExtractControllerConfigFrom extracts the applied configuration owned by fieldManager from
// controllerConfig for the specified subresource. Pass an empty string for subresource to extract
// the main resource. Common subresources include "status", "scale", etc.
// controllerConfig must be a unmodified ControllerConfig API object that was retrieved from the Kubernetes API.
// ExtractControllerConfigFrom provides a way to perform a extract/modify-in-place/apply workflow.
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractControllerConfigFrom(controllerConfig *machineconfigurationv1.ControllerConfig, fieldManager string, subresource string) (*ControllerConfigApplyConfiguration, error) {
	b := &ControllerConfigApplyConfiguration{}
...
func ExtractControllerConfig(controllerConfig *machineconfigurationv1.ControllerConfig, fieldManager string) (*ControllerConfigApplyConfiguration, error) {
	return ExtractControllerConfigFrom(controllerConfig, fieldManager, "")
}

// ExtractControllerConfigStatus extracts the applied configuration owned by fieldManager from
// controllerConfig for the status subresource.
func ExtractControllerConfigStatus(controllerConfig *machineconfigurationv1.ControllerConfig, fieldManager string) (*ControllerConfigApplyConfiguration, error) {
	return ExtractControllerConfigFrom(controllerConfig, fieldManager, "status")
}

func (b ControllerConfigApplyConfiguration) IsApplyConfiguration() {}
...
func (b *ControllerConfigApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *ControllerConfigApplyConfiguration) GetAPIVersion() *string {
...
func (b *ControllerConfigApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
