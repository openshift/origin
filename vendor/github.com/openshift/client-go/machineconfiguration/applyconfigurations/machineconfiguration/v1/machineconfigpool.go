...
func (b *MachineConfigPoolApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *MachineConfigPoolApplyConfiguration) GetAPIVersion() *string {
...
func (b *MachineConfigPoolApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
