...
func ExtractMachineConfigNodeFrom(machineConfigNode *machineconfigurationv1.MachineConfigNode, fieldManager string, subresource string) (*MachineConfigNodeApplyConfiguration, error) {
	b := &MachineConfigNodeApplyConfiguration{}
	err := managedfields.ExtractInto(machineConfigNode, internal.Parser().Type("com.github.openshift.api.machineconfiguration.v1.MachineConfigNode"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractMachineConfigNode(machineConfigNode *machineconfigurationv1.MachineConfigNode, fieldManager string) (*MachineConfigNodeApplyConfiguration, error) {
...
func ExtractMachineConfigNodeStatus(machineConfigNode *machineconfigurationv1.MachineConfigNode, fieldManager string) (*MachineConfigNodeApplyConfiguration, error) {
...
func (b *MachineConfigNodeApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *MachineConfigNodeApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *MachineConfigNodeApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *MachineConfigNodeApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *MachineConfigNodeApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *MachineConfigNodeApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
