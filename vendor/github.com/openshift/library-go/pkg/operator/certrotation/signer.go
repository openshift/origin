...
func setSigningCertKeyPairSecretAndTLSAnnotations(signingCertKeyPairSecret *corev1.Secret, validity time.Duration, tlsAnnotations AdditionalAnnotations) error {
	...
	SetTLSAnnotationsOnCertKeyPairSecret(signingCertKeyPairSecret, ca, tlsAnnotations)
	return nil
}
...
// This function is applicable to both signing and target cert key pair secrets.
//
...
// has been initialized in setSigningCertKeyPairSecret / setTargetCertKeyPairSecret.
func SetTLSAnnotationsOnCertKeyPairSecret(certKeyPairSecret *corev1.Secret, ca *crypto.TLSCertificateConfig, tlsAnnotations AdditionalAnnotations) {
	if certKeyPairSecret.Annotations == nil {
		certKeyPairSecret.Annotations = map[string]string{}
	}
	certKeyPairSecret.Annotations[CertificateIssuer] = ca.Certs[0].Issuer.CommonName
	...
	_ = tlsAnnotations.EnsureTLSMetadataUpdate(&certKeyPairSecret.ObjectMeta)
}
