...
// GetQuickXorHash gets the quickXorHash property value. A proprietary hash of the file that can be used to determine if the contents of the file change (if available). Read-only.
// returns a *string when successful
...
// GetSha256Hash gets the sha256Hash property value. This property isn't supported. Don't use.
// returns a *string when successful
...
// SetQuickXorHash sets the quickXorHash property value. A proprietary hash of the file that can be used to determine if the contents of the file change (if available). Read-only.
...
// SetSha256Hash sets the sha256Hash property value. This property isn't supported. Don't use.
