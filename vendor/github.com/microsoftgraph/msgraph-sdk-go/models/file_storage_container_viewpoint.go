...
func (m *FileStorageContainerViewpoint) GetBackingStore()(ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore) {
...
func (m *FileStorageContainerViewpoint) GetEffectiveRole()(*string) {
    val, err := m.GetBackingStore().Get("effectiveRole")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *FileStorageContainerViewpoint) SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)() {
...
func (m *FileStorageContainerViewpoint) SetEffectiveRole(value *string)() {
    err := m.GetBackingStore().Set("effectiveRole", value)
    if err != nil {
        panic(err)
    }
}
