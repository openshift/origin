...
func (m *Storage) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["fileStorage"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateFileStorageFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetFileStorage(val.(FileStorageable))
        }
        return nil
    }
...
func (m *Storage) GetFileStorage()(FileStorageable) {
    val, err := m.GetBackingStore().Get("fileStorage")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(FileStorageable)
    }
    return nil
}
...
func (m *Storage) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
        err := writer.WriteObjectValue("fileStorage", m.GetFileStorage())
        if err != nil {
            return err
        }
    }
...
// SetFileStorage sets the fileStorage property value. The fileStorage property
func (m *Storage) SetFileStorage(value FileStorageable)() {
    err := m.GetBackingStore().Set("fileStorage", value)
    if err != nil {
        panic(err)
    }
}
