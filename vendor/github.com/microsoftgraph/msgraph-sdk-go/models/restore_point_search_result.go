...
// NewRestorePointSearchResult instantiates a new RestorePointSearchResult and sets the default values.
func NewRestorePointSearchResult()(*RestorePointSearchResult) {
    m := &RestorePointSearchResult{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateRestorePointSearchResultFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateRestorePointSearchResultFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewRestorePointSearchResult(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *RestorePointSearchResult) GetAdditionalData()(map[string]any) {
...
func (m *RestorePointSearchResult) GetOdataType()(*string) {
...
// GetRestorePoint gets the restorePoint property value. The restorePoint property
// returns a RestorePointable when successful
func (m *RestorePointSearchResult) GetRestorePoint()(RestorePointable) {
...
func (m *RestorePointSearchResult) SetAdditionalData(value map[string]any)() {
...
func (m *RestorePointSearchResult) SetOdataType(value *string)() {
    err := m.GetBackingStore().Set("odataType", value)
    if err != nil {
        panic(err)
    }
}
// SetRestorePoint sets the restorePoint property value. The restorePoint property
func (m *RestorePointSearchResult) SetRestorePoint(value RestorePointable)() {
    err := m.GetBackingStore().Set("restorePoint", value)
    if err != nil {
        panic(err)
    }
}
type RestorePointSearchResultable interface {
