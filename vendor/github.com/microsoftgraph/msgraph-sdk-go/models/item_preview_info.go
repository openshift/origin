...
func (m *ItemPreviewInfo) GetGetUrl()(*string) {
    val, err := m.GetBackingStore().Get("getUrl")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ItemPreviewInfo) GetPostParameters()(*string) {
    val, err := m.GetBackingStore().Get("postParameters")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ItemPreviewInfo) GetPostUrl()(*string) {
    val, err := m.GetBackingStore().Get("postUrl")
    if err != nil {
        panic(err)
    }
    if val != nil {
...
func (m *ItemPreviewInfo) SetGetUrl(value *string)() {
    err := m.GetBackingStore().Set("getUrl", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *ItemPreviewInfo) SetPostParameters(value *string)() {
    err := m.GetBackingStore().Set("postParameters", value)
    if err != nil {
        panic(err)
    }
}
...
func (m *ItemPreviewInfo) SetPostUrl(value *string)() {
    err := m.GetBackingStore().Set("postUrl", value)
    if err != nil {
        panic(err)
    }
}
