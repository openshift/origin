...
type BackupRestoreMailboxProtectionUnitsCountRequestBuilderGetQueryParameters struct {
...
type BackupRestoreMailboxProtectionUnitsCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *BackupRestoreMailboxProtectionUnitsCountRequestBuilderGetQueryParameters
}
...
func NewBackupRestoreMailboxProtectionUnitsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreMailboxProtectionUnitsCountRequestBuilder) {
    m := &BackupRestoreMailboxProtectionUnitsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/backupRestore/mailboxProtectionUnits/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewBackupRestoreMailboxProtectionUnitsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreMailboxProtectionUnitsCountRequestBuilder) {
    ...
    return NewBackupRestoreMailboxProtectionUnitsCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *BackupRestoreMailboxProtectionUnitsCountRequestBuilder) WithUrl(rawUrl string)(*BackupRestoreMailboxProtectionUnitsCountRequestBuilder) {
    return NewBackupRestoreMailboxProtectionUnitsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
