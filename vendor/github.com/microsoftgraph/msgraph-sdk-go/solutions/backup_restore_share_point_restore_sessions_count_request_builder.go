...
type BackupRestoreSharePointRestoreSessionsCountRequestBuilderGetQueryParameters struct {
...
type BackupRestoreSharePointRestoreSessionsCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *BackupRestoreSharePointRestoreSessionsCountRequestBuilderGetQueryParameters
}
...
func NewBackupRestoreSharePointRestoreSessionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreSharePointRestoreSessionsCountRequestBuilder) {
    m := &BackupRestoreSharePointRestoreSessionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/backupRestore/sharePointRestoreSessions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewBackupRestoreSharePointRestoreSessionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreSharePointRestoreSessionsCountRequestBuilder) {
    ...
    return NewBackupRestoreSharePointRestoreSessionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *BackupRestoreSharePointRestoreSessionsCountRequestBuilder) WithUrl(rawUrl string)(*BackupRestoreSharePointRestoreSessionsCountRequestBuilder) {
    return NewBackupRestoreSharePointRestoreSessionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
