...
// BackupRestoreRestorePointsRequestBuilderGetQueryParameters get a list of the restorePoint objects and their properties.
type BackupRestoreRestorePointsRequestBuilderGetQueryParameters struct {
...
type BackupRestoreRestorePointsRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *BackupRestoreRestorePointsRequestBuilderGetQueryParameters
}
...
type BackupRestoreRestorePointsRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
func NewBackupRestoreRestorePointsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreRestorePointsRequestBuilder) {
    m := &BackupRestoreRestorePointsRequestBuilder{
...
func NewBackupRestoreRestorePointsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreRestorePointsRequestBuilder) {
    ...
    return NewBackupRestoreRestorePointsRequestBuilderInternal(urlParams, requestAdapter)
}
...
// Get get a list of the restorePoint objects and their properties.
...
func (m *BackupRestoreRestorePointsRequestBuilder) Get(ctx context.Context, requestConfiguration *BackupRestoreRestorePointsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.RestorePointCollectionResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateRestorePointCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.RestorePointCollectionResponseable), nil
}
...
// ToGetRequestInformation get a list of the restorePoint objects and their properties.
...
func (m *BackupRestoreRestorePointsRequestBuilder) WithUrl(rawUrl string)(*BackupRestoreRestorePointsRequestBuilder) {
    return NewBackupRestoreRestorePointsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
