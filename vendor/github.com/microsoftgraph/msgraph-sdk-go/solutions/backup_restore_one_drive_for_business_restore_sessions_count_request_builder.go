...
type BackupRestoreOneDriveForBusinessRestoreSessionsCountRequestBuilderGetQueryParameters struct {
...
type BackupRestoreOneDriveForBusinessRestoreSessionsCountRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *BackupRestoreOneDriveForBusinessRestoreSessionsCountRequestBuilderGetQueryParameters
}
...
func NewBackupRestoreOneDriveForBusinessRestoreSessionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreOneDriveForBusinessRestoreSessionsCountRequestBuilder) {
    m := &BackupRestoreOneDriveForBusinessRestoreSessionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/solutions/backupRestore/oneDriveForBusinessRestoreSessions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewBackupRestoreOneDriveForBusinessRestoreSessionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BackupRestoreOneDriveForBusinessRestoreSessionsCountRequestBuilder) {
    ...
    return NewBackupRestoreOneDriveForBusinessRestoreSessionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *BackupRestoreOneDriveForBusinessRestoreSessionsCountRequestBuilder) WithUrl(rawUrl string)(*BackupRestoreOneDriveForBusinessRestoreSessionsCountRequestBuilder) {
    return NewBackupRestoreOneDriveForBusinessRestoreSessionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
