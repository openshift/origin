...
// NewItemItemsItemWorkbookFunctionsCoupDaysNcRequestBuilderInternal instantiates a new ItemItemsItemWorkbookFunctionsCoupDaysNcRequestBuilder and sets the default values.
...
// NewItemItemsItemWorkbookFunctionsCoupDaysNcRequestBuilder instantiates a new ItemItemsItemWorkbookFunctionsCoupDaysNcRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookFunctionsCoupDaysNcRequestBuilder) WithUrl(rawUrl string)(*ItemItemsItemWorkbookFunctionsCoupDaysNcRequestBuilder) {
    return NewItemItemsItemWorkbookFunctionsCoupDaysNcRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
