...
// NewItemItemsItemWorkbookFunctionsRomanRequestBuilderInternal instantiates a new ItemItemsItemWorkbookFunctionsRomanRequestBuilder and sets the default values.
...
// NewItemItemsItemWorkbookFunctionsRomanRequestBuilder instantiates a new ItemItemsItemWorkbookFunctionsRomanRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookFunctionsRomanRequestBuilder) WithUrl(rawUrl string)(*ItemItemsItemWorkbookFunctionsRomanRequestBuilder) {
    return NewItemItemsItemWorkbookFunctionsRomanRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
