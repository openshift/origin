...
type ItemItemsItemWorkbookWorksheetsItemChartsItemImageWithWidthGetResponse struct {
    // Stores model information.
    backingStore ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore
}
// NewItemItemsItemWorkbookWorksheetsItemChartsItemImageWithWidthGetResponse instantiates a new ItemItemsItemWorkbookWorksheetsItemChartsItemImageWithWidthGetResponse and sets the default values.
...
// CreateItemItemsItemWorkbookWorksheetsItemChartsItemImageWithWidthGetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ItemItemsItemWorkbookWorksheetsItemChartsItemImageWithWidthGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemItemsItemWorkbookWorksheetsItemChartsItemImageWithWidthGetResponse) GetValue()(*string) {
...
func (m *ItemItemsItemWorkbookWorksheetsItemChartsItemImageWithWidthGetResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemItemsItemWorkbookWorksheetsItemChartsItemImageWithWidthGetResponse) SetValue(value *string)() {
    err := m.GetBackingStore().Set("value", value)
    if err != nil {
        panic(err)
    }
}
type ItemItemsItemWorkbookWorksheetsItemChartsItemImageWithWidthGetResponseable interface {
