...
// NewItemItemsItemWorkbookFunctionsDollarRequestBuilderInternal instantiates a new ItemItemsItemWorkbookFunctionsDollarRequestBuilder and sets the default values.
...
// NewItemItemsItemWorkbookFunctionsDollarRequestBuilder instantiates a new ItemItemsItemWorkbookFunctionsDollarRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookFunctionsDollarRequestBuilder) WithUrl(rawUrl string)(*ItemItemsItemWorkbookFunctionsDollarRequestBuilder) {
    return NewItemItemsItemWorkbookFunctionsDollarRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
