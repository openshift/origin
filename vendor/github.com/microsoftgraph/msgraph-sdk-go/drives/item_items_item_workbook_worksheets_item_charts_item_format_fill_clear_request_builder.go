...
// NewItemItemsItemWorkbookWorksheetsItemChartsItemFormatFillClearRequestBuilderInternal instantiates a new ItemItemsItemWorkbookWorksheetsItemChartsItemFormatFillClearRequestBuilder and sets the default values.
...
// NewItemItemsItemWorkbookWorksheetsItemChartsItemFormatFillClearRequestBuilder instantiates a new ItemItemsItemWorkbookWorksheetsItemChartsItemFormatFillClearRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookWorksheetsItemChartsItemFormatFillClearRequestBuilder) WithUrl(rawUrl string)(*ItemItemsItemWorkbookWorksheetsItemChartsItemFormatFillClearRequestBuilder) {
    return NewItemItemsItemWorkbookWorksheetsItemChartsItemFormatFillClearRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
