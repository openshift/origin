...
// NewMobileAppsItemGraphIosVppAppRequestBuilderInternal instantiates a new MobileAppsItemGraphIosVppAppRequestBuilder and sets the default values.
...
// NewMobileAppsItemGraphIosVppAppRequestBuilder instantiates a new MobileAppsItemGraphIosVppAppRequestBuilder and sets the default values.
...
func (m *MobileAppsItemGraphIosVppAppRequestBuilder) Get(ctx context.Context, requestConfiguration *MobileAppsItemGraphIosVppAppRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.IosVppAppable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateIosVppAppFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.IosVppAppable), nil
}
