...
// NewItemPrimaryChannelTabsTeamsTabItemRequestBuilderInternal instantiates a new ItemPrimaryChannelTabsTeamsTabItemRequestBuilder and sets the default values.
func NewItemPrimaryChannelTabsTeamsTabItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemPrimaryChannelTabsTeamsTabItemRequestBuilder) {
    m := &ItemPrimaryChannelTabsTeamsTabItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/teams/{team%2Did}/primaryChannel/tabs/{teamsTab%2Did}{?%24expand,%24select}", pathParameters),
    }
    return m
}
// NewItemPrimaryChannelTabsTeamsTabItemRequestBuilder instantiates a new ItemPrimaryChannelTabsTeamsTabItemRequestBuilder and sets the default values.
func NewItemPrimaryChannelTabsTeamsTabItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemPrimaryChannelTabsTeamsTabItemRequestBuilder) {
...
func (m *ItemPrimaryChannelTabsTeamsTabItemRequestBuilder) WithUrl(rawUrl string)(*ItemPrimaryChannelTabsTeamsTabItemRequestBuilder) {
    return NewItemPrimaryChannelTabsTeamsTabItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
