...
// NewItemChatsItemMessagesItemSoftDeleteRequestBuilderInternal instantiates a new ItemChatsItemMessagesItemSoftDeleteRequestBuilder and sets the default values.
func NewItemChatsItemMessagesItemSoftDeleteRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemChatsItemMessagesItemSoftDeleteRequestBuilder) {
    m := &ItemChatsItemMessagesItemSoftDeleteRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/messages/{chatMessage%2Did}/softDelete", pathParameters),
    }
    return m
}
// NewItemChatsItemMessagesItemSoftDeleteRequestBuilder instantiates a new ItemChatsItemMessagesItemSoftDeleteRequestBuilder and sets the default values.
...
func (m *ItemChatsItemMessagesItemSoftDeleteRequestBuilder) WithUrl(rawUrl string)(*ItemChatsItemMessagesItemSoftDeleteRequestBuilder) {
    return NewItemChatsItemMessagesItemSoftDeleteRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
