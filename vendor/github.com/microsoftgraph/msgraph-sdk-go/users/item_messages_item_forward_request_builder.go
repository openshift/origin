...
// NewItemMessagesItemForwardRequestBuilderInternal instantiates a new ItemMessagesItemForwardRequestBuilder and sets the default values.
func NewItemMessagesItemForwardRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMessagesItemForwardRequestBuilder) {
    m := &ItemMessagesItemForwardRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user%2Did}/messages/{message%2Did}/forward", pathParameters),
    }
    return m
}
// NewItemMessagesItemForwardRequestBuilder instantiates a new ItemMessagesItemForwardRequestBuilder and sets the default values.
...
func (m *ItemMessagesItemForwardRequestBuilder) WithUrl(rawUrl string)(*ItemMessagesItemForwardRequestBuilder) {
    return NewItemMessagesItemForwardRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
