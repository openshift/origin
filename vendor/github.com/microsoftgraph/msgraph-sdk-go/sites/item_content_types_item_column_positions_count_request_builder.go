...
// NewItemContentTypesItemColumnPositionsCountRequestBuilderInternal instantiates a new ItemContentTypesItemColumnPositionsCountRequestBuilder and sets the default values.
func NewItemContentTypesItemColumnPositionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemContentTypesItemColumnPositionsCountRequestBuilder) {
    m := &ItemContentTypesItemColumnPositionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/sites/{site%2Did}/contentTypes/{contentType%2Did}/columnPositions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewItemContentTypesItemColumnPositionsCountRequestBuilder instantiates a new ItemContentTypesItemColumnPositionsCountRequestBuilder and sets the default values.
...
func (m *ItemContentTypesItemColumnPositionsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemContentTypesItemColumnPositionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemContentTypesItemColumnPositionsCountRequestBuilder) WithUrl(rawUrl string)(*ItemContentTypesItemColumnPositionsCountRequestBuilder) {
    return NewItemContentTypesItemColumnPositionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
