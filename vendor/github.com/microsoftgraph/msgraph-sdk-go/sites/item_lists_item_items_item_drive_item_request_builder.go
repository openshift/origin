...
// NewItemListsItemItemsItemDriveItemRequestBuilderInternal instantiates a new ItemListsItemItemsItemDriveItemRequestBuilder and sets the default values.
...
// NewItemListsItemItemsItemDriveItemRequestBuilder instantiates a new ItemListsItemItemsItemDriveItemRequestBuilder and sets the default values.
...
func (m *ItemListsItemItemsItemDriveItemRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemListsItemItemsItemDriveItemRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemListsItemItemsItemDriveItemRequestBuilder) WithUrl(rawUrl string)(*ItemListsItemItemsItemDriveItemRequestBuilder) {
    return NewItemListsItemItemsItemDriveItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
