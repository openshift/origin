...
func NewOnlineMeetingsItemAttendanceReportsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OnlineMeetingsItemAttendanceReportsCountRequestBuilder) {
    m := &OnlineMeetingsItemAttendanceReportsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/attendanceReports/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewOnlineMeetingsItemAttendanceReportsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*OnlineMeetingsItemAttendanceReportsCountRequestBuilder) {
    ...
    return NewOnlineMeetingsItemAttendanceReportsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *OnlineMeetingsItemAttendanceReportsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *OnlineMeetingsItemAttendanceReportsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *OnlineMeetingsItemAttendanceReportsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *OnlineMeetingsItemAttendanceReportsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *OnlineMeetingsItemAttendanceReportsCountRequestBuilder) WithUrl(rawUrl string)(*OnlineMeetingsItemAttendanceReportsCountRequestBuilder) {
    return NewOnlineMeetingsItemAttendanceReportsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
