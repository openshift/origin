...
// AttackSimulationTrainingsItemLanguageDetailsTrainingLanguageDetailItemRequestBuilderGetQueryParameters get the language details about an attack simulation training for a tenant.
