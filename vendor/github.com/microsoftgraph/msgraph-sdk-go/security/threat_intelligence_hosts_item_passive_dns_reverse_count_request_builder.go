...
func NewThreatIntelligenceHostsItemPassiveDnsReverseCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatIntelligenceHostsItemPassiveDnsReverseCountRequestBuilder) {
    m := &ThreatIntelligenceHostsItemPassiveDnsReverseCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/passiveDnsReverse/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewThreatIntelligenceHostsItemPassiveDnsReverseCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ThreatIntelligenceHostsItemPassiveDnsReverseCountRequestBuilder) {
    ...
    return NewThreatIntelligenceHostsItemPassiveDnsReverseCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ThreatIntelligenceHostsItemPassiveDnsReverseCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ThreatIntelligenceHostsItemPassiveDnsReverseCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *ThreatIntelligenceHostsItemPassiveDnsReverseCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ThreatIntelligenceHostsItemPassiveDnsReverseCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ThreatIntelligenceHostsItemPassiveDnsReverseCountRequestBuilder) WithUrl(rawUrl string)(*ThreatIntelligenceHostsItemPassiveDnsReverseCountRequestBuilder) {
    return NewThreatIntelligenceHostsItemPassiveDnsReverseCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
