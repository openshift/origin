...
// NewDirectoryRoleAssignmentsItemRoleDefinitionRequestBuilderInternal instantiates a new DirectoryRoleAssignmentsItemRoleDefinitionRequestBuilder and sets the default values.
func NewDirectoryRoleAssignmentsItemRoleDefinitionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleAssignmentsItemRoleDefinitionRequestBuilder) {
    m := &DirectoryRoleAssignmentsItemRoleDefinitionRequestBuilder{
...
// NewDirectoryRoleAssignmentsItemRoleDefinitionRequestBuilder instantiates a new DirectoryRoleAssignmentsItemRoleDefinitionRequestBuilder and sets the default values.
...
func (m *DirectoryRoleAssignmentsItemRoleDefinitionRequestBuilder) WithUrl(rawUrl string)(*DirectoryRoleAssignmentsItemRoleDefinitionRequestBuilder) {
    return NewDirectoryRoleAssignmentsItemRoleDefinitionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
