...
// NewDirectoryRoleAssignmentSchedulesItemDirectoryScopeRequestBuilderInternal instantiates a new DirectoryRoleAssignmentSchedulesItemDirectoryScopeRequestBuilder and sets the default values.
func NewDirectoryRoleAssignmentSchedulesItemDirectoryScopeRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleAssignmentSchedulesItemDirectoryScopeRequestBuilder) {
    m := &DirectoryRoleAssignmentSchedulesItemDirectoryScopeRequestBuilder{
...
// NewDirectoryRoleAssignmentSchedulesItemDirectoryScopeRequestBuilder instantiates a new DirectoryRoleAssignmentSchedulesItemDirectoryScopeRequestBuilder and sets the default values.
func NewDirectoryRoleAssignmentSchedulesItemDirectoryScopeRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleAssignmentSchedulesItemDirectoryScopeRequestBuilder) {
    ...
    return NewDirectoryRoleAssignmentSchedulesItemDirectoryScopeRequestBuilderInternal(urlParams, requestAdapter)
}
// Get the directory object that is the scope of the role eligibility or assignment. Read-only.
// returns a DirectoryObjectable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *DirectoryRoleAssignmentSchedulesItemDirectoryScopeRequestBuilder) Get(ctx context.Context, requestConfiguration *DirectoryRoleAssignmentSchedulesItemDirectoryScopeRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DirectoryObjectable, error) {
...
func (m *DirectoryRoleAssignmentSchedulesItemDirectoryScopeRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DirectoryRoleAssignmentSchedulesItemDirectoryScopeRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *DirectoryRoleAssignmentSchedulesItemDirectoryScopeRequestBuilder) WithUrl(rawUrl string)(*DirectoryRoleAssignmentSchedulesItemDirectoryScopeRequestBuilder) {
    return NewDirectoryRoleAssignmentSchedulesItemDirectoryScopeRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
