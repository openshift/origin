...
// DirectoryRoleAssignmentsItemPrincipalRequestBuilderGetQueryParameters referencing the assigned principal. Read-only. Supports $expand except for the Exchange provider.
...
func NewDirectoryRoleAssignmentsItemPrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DirectoryRoleAssignmentsItemPrincipalRequestBuilder) {
    m := &DirectoryRoleAssignmentsItemPrincipalRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/roleManagement/directory/roleAssignments/{unifiedRoleAssignment%2Did}/principal{?%24expand,%24select}", pathParameters),
    }
    return m
}
...
func (m *DirectoryRoleAssignmentsItemPrincipalRequestBuilder) WithUrl(rawUrl string)(*DirectoryRoleAssignmentsItemPrincipalRequestBuilder) {
    return NewDirectoryRoleAssignmentsItemPrincipalRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
