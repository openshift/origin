...
func NewUserExperienceAnalyticsAppHealthDevicePerformanceCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserExperienceAnalyticsAppHealthDevicePerformanceCountRequestBuilder) {
    m := &UserExperienceAnalyticsAppHealthDevicePerformanceCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthDevicePerformance/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewUserExperienceAnalyticsAppHealthDevicePerformanceCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UserExperienceAnalyticsAppHealthDevicePerformanceCountRequestBuilder) {
    ...
    return NewUserExperienceAnalyticsAppHealthDevicePerformanceCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *UserExperienceAnalyticsAppHealthDevicePerformanceCountRequestBuilder) Get(ctx context.Context, requestConfiguration *UserExperienceAnalyticsAppHealthDevicePerformanceCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *UserExperienceAnalyticsAppHealthDevicePerformanceCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *UserExperienceAnalyticsAppHealthDevicePerformanceCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *UserExperienceAnalyticsAppHealthDevicePerformanceCountRequestBuilder) WithUrl(rawUrl string)(*UserExperienceAnalyticsAppHealthDevicePerformanceCountRequestBuilder) {
    return NewUserExperienceAnalyticsAppHealthDevicePerformanceCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
