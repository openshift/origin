...
// CreateManagedDevicesItemLogCollectionRequestsItemCreateDownloadUrlPostResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *ManagedDevicesItemLogCollectionRequestsItemCreateDownloadUrlPostResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ManagedDevicesItemLogCollectionRequestsItemCreateDownloadUrlPostResponse) GetValue()(*string) {
...
func (m *ManagedDevicesItemLogCollectionRequestsItemCreateDownloadUrlPostResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ManagedDevicesItemLogCollectionRequestsItemCreateDownloadUrlPostResponse) SetValue(value *string)() {
    err := m.GetBackingStore().Set("value", value)
    if err != nil {
        panic(err)
    }
}
type ManagedDevicesItemLogCollectionRequestsItemCreateDownloadUrlPostResponseable interface {
