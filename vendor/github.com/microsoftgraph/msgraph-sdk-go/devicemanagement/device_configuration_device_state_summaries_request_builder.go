...
func (m *DeviceConfigurationDeviceStateSummariesRequestBuilder) WithUrl(rawUrl string)(*DeviceConfigurationDeviceStateSummariesRequestBuilder) {
    return NewDeviceConfigurationDeviceStateSummariesRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
