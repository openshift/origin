...
func (m *AuthorizationPolicyRequestBuilder) WithUrl(rawUrl string)(*AuthorizationPolicyRequestBuilder) {
    return NewAuthorizationPolicyRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
