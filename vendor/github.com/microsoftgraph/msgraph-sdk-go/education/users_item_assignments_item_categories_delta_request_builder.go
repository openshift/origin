...
// NewUsersItemAssignmentsItemCategoriesDeltaRequestBuilderInternal instantiates a new UsersItemAssignmentsItemCategoriesDeltaRequestBuilder and sets the default values.
func NewUsersItemAssignmentsItemCategoriesDeltaRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*UsersItemAssignmentsItemCategoriesDeltaRequestBuilder) {
    m := &UsersItemAssignmentsItemCategoriesDeltaRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/categories/delta(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters),
    }
    return m
}
// NewUsersItemAssignmentsItemCategoriesDeltaRequestBuilder instantiates a new UsersItemAssignmentsItemCategoriesDeltaRequestBuilder and sets the default values.
