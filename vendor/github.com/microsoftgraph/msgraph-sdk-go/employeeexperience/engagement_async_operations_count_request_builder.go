...
func NewEngagementAsyncOperationsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EngagementAsyncOperationsCountRequestBuilder) {
    m := &EngagementAsyncOperationsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/employeeExperience/engagementAsyncOperations/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewEngagementAsyncOperationsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EngagementAsyncOperationsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewEngagementAsyncOperationsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *EngagementAsyncOperationsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EngagementAsyncOperationsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *EngagementAsyncOperationsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *EngagementAsyncOperationsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EngagementAsyncOperationsCountRequestBuilder) WithUrl(rawUrl string)(*EngagementAsyncOperationsCountRequestBuilder) {
    return NewEngagementAsyncOperationsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
