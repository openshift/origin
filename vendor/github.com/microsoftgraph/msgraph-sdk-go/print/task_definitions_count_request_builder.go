...
func NewTaskDefinitionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TaskDefinitionsCountRequestBuilder) {
    m := &TaskDefinitionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/print/taskDefinitions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func (m *TaskDefinitionsCountRequestBuilder) WithUrl(rawUrl string)(*TaskDefinitionsCountRequestBuilder) {
    return NewTaskDefinitionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
