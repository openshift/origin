...
func NewPrintersItemJobsItemAbortPostRequestBody()(*PrintersItemJobsItemAbortPostRequestBody) {
    m := &PrintersItemJobsItemAbortPostRequestBody{
    }
    m.backingStore = ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStoreFactoryInstance();
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreatePrintersItemJobsItemAbortPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func (m *PrintersItemJobsItemAbortPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *PrintersItemJobsItemAbortPostRequestBody) GetReason()(*string) {
...
func (m *PrintersItemJobsItemAbortPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
type PrintersItemJobsItemAbortPostRequestBodyable interface {
