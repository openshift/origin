...
// NewItemSitesItemContentTypesAddCopyRequestBuilderInternal instantiates a new ItemSitesItemContentTypesAddCopyRequestBuilder and sets the default values.
...
// NewItemSitesItemContentTypesAddCopyRequestBuilder instantiates a new ItemSitesItemContentTypesAddCopyRequestBuilder and sets the default values.
...
func (m *ItemSitesItemContentTypesAddCopyRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemContentTypesAddCopyRequestBuilder) {
    return NewItemSitesItemContentTypesAddCopyRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
