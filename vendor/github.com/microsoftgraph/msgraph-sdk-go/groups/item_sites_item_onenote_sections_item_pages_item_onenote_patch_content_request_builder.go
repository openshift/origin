...
// NewItemSitesItemOnenoteSectionsItemPagesItemOnenotePatchContentRequestBuilderInternal instantiates a new ItemSitesItemOnenoteSectionsItemPagesItemOnenotePatchContentRequestBuilder and sets the default values.
...
// NewItemSitesItemOnenoteSectionsItemPagesItemOnenotePatchContentRequestBuilder instantiates a new ItemSitesItemOnenoteSectionsItemPagesItemOnenotePatchContentRequestBuilder and sets the default values.
...
func (m *ItemSitesItemOnenoteSectionsItemPagesItemOnenotePatchContentRequestBuilder) WithUrl(rawUrl string)(*ItemSitesItemOnenoteSectionsItemPagesItemOnenotePatchContentRequestBuilder) {
    return NewItemSitesItemOnenoteSectionsItemPagesItemOnenotePatchContentRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
