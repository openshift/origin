...
// NewItemTeamPrimaryChannelMessagesItemRepliesItemUndoSoftDeleteRequestBuilderInternal instantiates a new ItemTeamPrimaryChannelMessagesItemRepliesItemUndoSoftDeleteRequestBuilder and sets the default values.
...
// NewItemTeamPrimaryChannelMessagesItemRepliesItemUndoSoftDeleteRequestBuilder instantiates a new ItemTeamPrimaryChannelMessagesItemRepliesItemUndoSoftDeleteRequestBuilder and sets the default values.
...
func (m *ItemTeamPrimaryChannelMessagesItemRepliesItemUndoSoftDeleteRequestBuilder) WithUrl(rawUrl string)(*ItemTeamPrimaryChannelMessagesItemRepliesItemUndoSoftDeleteRequestBuilder) {
    return NewItemTeamPrimaryChannelMessagesItemRepliesItemUndoSoftDeleteRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
