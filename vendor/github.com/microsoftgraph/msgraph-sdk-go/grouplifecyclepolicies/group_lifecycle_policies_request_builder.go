...
// Post creates a new groupLifecyclePolicy. Only one policy exists in the tenant.
...
// ToPostRequestInformation creates a new groupLifecyclePolicy. Only one policy exists in the tenant.
// returns a *RequestInformation when successful
