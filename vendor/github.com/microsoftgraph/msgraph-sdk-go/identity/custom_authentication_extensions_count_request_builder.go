...
func NewCustomAuthenticationExtensionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CustomAuthenticationExtensionsCountRequestBuilder) {
    m := &CustomAuthenticationExtensionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identity/customAuthenticationExtensions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewCustomAuthenticationExtensionsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CustomAuthenticationExtensionsCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewCustomAuthenticationExtensionsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *CustomAuthenticationExtensionsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *CustomAuthenticationExtensionsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *CustomAuthenticationExtensionsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *CustomAuthenticationExtensionsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *CustomAuthenticationExtensionsCountRequestBuilder) WithUrl(rawUrl string)(*CustomAuthenticationExtensionsCountRequestBuilder) {
    return NewCustomAuthenticationExtensionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
