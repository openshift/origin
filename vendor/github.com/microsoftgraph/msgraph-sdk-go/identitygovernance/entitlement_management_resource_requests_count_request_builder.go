...
func NewEntitlementManagementResourceRequestsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementResourceRequestsCountRequestBuilder) {
    m := &EntitlementManagementResourceRequestsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/resourceRequests/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
...
func NewEntitlementManagementResourceRequestsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementResourceRequestsCountRequestBuilder) {
    ...
    return NewEntitlementManagementResourceRequestsCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *EntitlementManagementResourceRequestsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *EntitlementManagementResourceRequestsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *EntitlementManagementResourceRequestsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *EntitlementManagementResourceRequestsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EntitlementManagementResourceRequestsCountRequestBuilder) WithUrl(rawUrl string)(*EntitlementManagementResourceRequestsCountRequestBuilder) {
    return NewEntitlementManagementResourceRequestsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
