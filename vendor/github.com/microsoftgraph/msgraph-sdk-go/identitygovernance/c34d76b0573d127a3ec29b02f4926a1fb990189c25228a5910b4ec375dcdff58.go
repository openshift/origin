...
func (m *EntitlementManagementResourceRequestsItemCatalogResourcesItemScopesItemResourceRequestBuilder) Refresh()(*EntitlementManagementResourceRequestsItemCatalogResourcesItemScopesItemResourceRefreshRequestBuilder) {
    return NewEntitlementManagementResourceRequestsItemCatalogResourcesItemScopesItemResourceRefreshRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
