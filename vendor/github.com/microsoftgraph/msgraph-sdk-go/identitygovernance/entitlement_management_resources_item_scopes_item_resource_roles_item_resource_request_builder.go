...
// returns a *EntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilder when successful
func (m *EntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRequestBuilder) Refresh()(*EntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilder) {
    return NewEntitlementManagementResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
