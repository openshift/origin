...
func NewEntitlementManagementResourcesItemScopesItemResourceRefreshRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementResourcesItemScopesItemResourceRefreshRequestBuilder) {
    m := &EntitlementManagementResourcesItemScopesItemResourceRefreshRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/resources/{accessPackageResource%2Did}/scopes/{accessPackageResourceScope%2Did}/resource/refresh", pathParameters),
    }
    return m
}
...
func NewEntitlementManagementResourcesItemScopesItemResourceRefreshRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementResourcesItemScopesItemResourceRefreshRequestBuilder) {
    ...
    return NewEntitlementManagementResourcesItemScopesItemResourceRefreshRequestBuilderInternal(urlParams, requestAdapter)
}
// Post invoke action refresh
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *EntitlementManagementResourcesItemScopesItemResourceRefreshRequestBuilder) Post(ctx context.Context, requestConfiguration *EntitlementManagementResourcesItemScopesItemResourceRefreshRequestBuilderPostRequestConfiguration)(error) {
...
func (m *EntitlementManagementResourcesItemScopesItemResourceRefreshRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *EntitlementManagementResourcesItemScopesItemResourceRefreshRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *EntitlementManagementResourcesItemScopesItemResourceRefreshRequestBuilder) WithUrl(rawUrl string)(*EntitlementManagementResourcesItemScopesItemResourceRefreshRequestBuilder) {
    return NewEntitlementManagementResourcesItemScopesItemResourceRefreshRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
