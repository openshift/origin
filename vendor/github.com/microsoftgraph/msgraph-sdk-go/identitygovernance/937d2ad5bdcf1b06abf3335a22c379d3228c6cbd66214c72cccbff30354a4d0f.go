...
func (m *LifecycleWorkflowsInsightsMicrosoftGraphIdentityGovernanceTopTasksProcessedSummaryWithStartDateTimeWithEndDateTimeTopTasksProcessedSummaryWithStartDateTimeWithEndDateTimeGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["value"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(ibf6ed4fc8e373ed2600905053a507c004671ad1749cb4b6b77078a908490c430.CreateTopTasksInsightsSummaryFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]ibf6ed4fc8e373ed2600905053a507c004671ad1749cb4b6b77078a908490c430.TopTasksInsightsSummaryable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(ibf6ed4fc8e373ed2600905053a507c004671ad1749cb4b6b77078a908490c430.TopTasksInsightsSummaryable)
                }
            }
            m.SetValue(res)
        }
...
func (m *LifecycleWorkflowsInsightsMicrosoftGraphIdentityGovernanceTopTasksProcessedSummaryWithStartDateTimeWithEndDateTimeTopTasksProcessedSummaryWithStartDateTimeWithEndDateTimeGetResponse) GetValue()([]ibf6ed4fc8e373ed2600905053a507c004671ad1749cb4b6b77078a908490c430.TopTasksInsightsSummaryable) {
    val, err := m.GetBackingStore().Get("value")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.([]ibf6ed4fc8e373ed2600905053a507c004671ad1749cb4b6b77078a908490c430.TopTasksInsightsSummaryable)
    }
    return nil
}
...
func (m *LifecycleWorkflowsInsightsMicrosoftGraphIdentityGovernanceTopTasksProcessedSummaryWithStartDateTimeWithEndDateTimeTopTasksProcessedSummaryWithStartDateTimeWithEndDateTimeGetResponse) SetValue(value []ibf6ed4fc8e373ed2600905053a507c004671ad1749cb4b6b77078a908490c430.TopTasksInsightsSummaryable)() {
...
type LifecycleWorkflowsInsightsMicrosoftGraphIdentityGovernanceTopTasksProcessedSummaryWithStartDateTimeWithEndDateTimeTopTasksProcessedSummaryWithStartDateTimeWithEndDateTimeGetResponseable interface {
    ...
    GetValue()([]ibf6ed4fc8e373ed2600905053a507c004671ad1749cb4b6b77078a908490c430.TopTasksInsightsSummaryable)
    SetValue(value []ibf6ed4fc8e373ed2600905053a507c004671ad1749cb4b6b77078a908490c430.TopTasksInsightsSummaryable)()
}
