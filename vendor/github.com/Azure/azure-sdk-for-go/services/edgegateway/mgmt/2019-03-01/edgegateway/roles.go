...
func (client RolesClient) CreateOrUpdate(ctx context.Context, deviceName string, name string, role BasicRole, resourceGroupName string) (result RolesCreateOrUpdateFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.RolesClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateOrUpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.RolesClient", "CreateOrUpdate", result.Response(), "Failure sending request")
		return
	}
...
func (client RolesClient) Delete(ctx context.Context, deviceName string, name string, resourceGroupName string) (result RolesDeleteFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.RolesClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.RolesClient", "Delete", result.Response(), "Failure sending request")
		return
	}
...
func (client RolesClient) Get(ctx context.Context, deviceName string, name string, resourceGroupName string) (result RoleModel, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.RolesClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "edgegateway.RolesClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.RolesClient", "Get", resp, "Failure responding to request")
	}
...
func (client RolesClient) ListByDataBoxEdgeDevice(ctx context.Context, deviceName string, resourceGroupName string) (result RoleListPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.RolesClient", "ListByDataBoxEdgeDevice", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "edgegateway.RolesClient", "ListByDataBoxEdgeDevice", resp, "Failure sending request")
		return
	}

	result.rl, err = client.ListByDataBoxEdgeDeviceResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.RolesClient", "ListByDataBoxEdgeDevice", resp, "Failure responding to request")
	}
...
func (client RolesClient) listByDataBoxEdgeDeviceNextResults(ctx context.Context, lastResults RoleList) (result RoleList, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "edgegateway.RolesClient", "listByDataBoxEdgeDeviceNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "edgegateway.RolesClient", "listByDataBoxEdgeDeviceNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListByDataBoxEdgeDeviceResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.RolesClient", "listByDataBoxEdgeDeviceNextResults", resp, "Failure responding to next results request")
	}
	return
}
