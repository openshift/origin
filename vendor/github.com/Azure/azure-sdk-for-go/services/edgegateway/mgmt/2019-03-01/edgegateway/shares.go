...
func (client SharesClient) CreateOrUpdate(ctx context.Context, deviceName string, name string, share Share, resourceGroupName string) (result SharesCreateOrUpdateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("edgegateway.SharesClient", "CreateOrUpdate", err.Error())
	}

	req, err := client.CreateOrUpdatePreparer(ctx, deviceName, name, share, resourceGroupName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.SharesClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateOrUpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.SharesClient", "CreateOrUpdate", result.Response(), "Failure sending request")
		return
	}
...
func (client SharesClient) Delete(ctx context.Context, deviceName string, name string, resourceGroupName string) (result SharesDeleteFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.SharesClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.SharesClient", "Delete", result.Response(), "Failure sending request")
		return
	}
...
func (client SharesClient) Get(ctx context.Context, deviceName string, name string, resourceGroupName string) (result Share, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.SharesClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "edgegateway.SharesClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.SharesClient", "Get", resp, "Failure responding to request")
	}
...
func (client SharesClient) ListByDataBoxEdgeDevice(ctx context.Context, deviceName string, resourceGroupName string) (result ShareListPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.SharesClient", "ListByDataBoxEdgeDevice", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "edgegateway.SharesClient", "ListByDataBoxEdgeDevice", resp, "Failure sending request")
		return
	}

	result.sl, err = client.ListByDataBoxEdgeDeviceResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.SharesClient", "ListByDataBoxEdgeDevice", resp, "Failure responding to request")
	}
...
func (client SharesClient) listByDataBoxEdgeDeviceNextResults(ctx context.Context, lastResults ShareList) (result ShareList, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "edgegateway.SharesClient", "listByDataBoxEdgeDeviceNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "edgegateway.SharesClient", "listByDataBoxEdgeDeviceNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListByDataBoxEdgeDeviceResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.SharesClient", "listByDataBoxEdgeDeviceNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client SharesClient) Refresh(ctx context.Context, deviceName string, name string, resourceGroupName string) (result SharesRefreshFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.SharesClient", "Refresh", nil, "Failure preparing request")
		return
	}

	result, err = client.RefreshSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgegateway.SharesClient", "Refresh", result.Response(), "Failure sending request")
		return
	}
