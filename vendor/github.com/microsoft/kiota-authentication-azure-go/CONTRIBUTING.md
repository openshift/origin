# Contributing to the Kiota Azure authentication provider for Go

The Kiota Azure authentication provider for Go is available for all manner of contribution. There are a couple of different recommended paths to get contributions into the released version of this SDK.
