...
// NewV1VolumeSnapshotsGetallParams creates a new V1VolumeSnapshotsGetallParams object,
...
func NewV1VolumeSnapshotsGetallParams() *V1VolumeSnapshotsGetallParams {
	return &V1VolumeSnapshotsGetallParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewV1VolumeSnapshotsGetallParamsWithTimeout creates a new V1VolumeSnapshotsGetallParams object
...
// NewV1VolumeSnapshotsGetallParamsWithContext creates a new V1VolumeSnapshotsGetallParams object
...
// NewV1VolumeSnapshotsGetallParamsWithHTTPClient creates a new V1VolumeSnapshotsGetallParams object
...
V1VolumeSnapshotsGetallParams contains all the parameters to send to the API endpoint
	...
	for the v1 volume snapshots getall operation.

	Typically these are written to a http.Request.
*/
type V1VolumeSnapshotsGetallParams struct {
