...
// New creates a new internal operations images API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

// New creates a new internal operations images API client with basic auth credentials.
...
// New creates a new internal operations images API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
/*
Client for internal operations images API
*/
type Client struct {
...
type ClientService interface {
	InternalV1OperationsImagesDelete(params *InternalV1OperationsImagesDeleteParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*InternalV1OperationsImagesDeleteNoContent, error)

	InternalV1OperationsImagesPost(params *InternalV1OperationsImagesPostParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*InternalV1OperationsImagesPostCreated, error)
...
func (a *Client) InternalV1OperationsImagesDelete(params *InternalV1OperationsImagesDeleteParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*InternalV1OperationsImagesDeleteNoContent, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "internal.v1.operations.images.delete",
		Method:             "DELETE",
		PathPattern:        "/internal/v1/operations/images/{resource_crn}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &InternalV1OperationsImagesDeleteReader{formats: a.formats},
		AuthInfo:           authInfo,
...
func (a *Client) InternalV1OperationsImagesPost(params *InternalV1OperationsImagesPostParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*InternalV1OperationsImagesPostCreated, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "internal.v1.operations.images.post",
		Method:             "POST",
		PathPattern:        "/internal/v1/operations/images",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &InternalV1OperationsImagesPostReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
