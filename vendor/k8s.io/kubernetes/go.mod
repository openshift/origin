...
require (
	...
	github.com/openshift/api v3.9.1-0.20190907160150-763878ba9fae+incompatible
...
replace (
	...
	github.com/openshift/api => github.com/openshift/api v3.9.1-0.20190907160150-763878ba9fae+incompatible
