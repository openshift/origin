...
func Test_newJournalArgsFromURL(t *testing.T) {
	...
	tests := []struct {
		...
		{query: url.Values{"since": []string{"-1"}}, wantErr: true},
		{query: url.Values{"since": []string{"-y"}}, wantErr: true},
		{query: url.Values{"since": []string{"2019-12-04 02:00:00"}}, want: &journalArgs{Timeout: 30, CaseSensitive: true, Since: "2019-12-04 02:00:00"}},
		{query: url.Values{"since": []string{"2019-12-04 02:00:00.000"}}, want: &journalArgs{Timeout: 30, CaseSensitive: true, Since: "2019-12-04 02:00:00.000"}},
		...
		{query: url.Values{"until": []string{"2019-12-04 02:00:00"}}, want: &journalArgs{Timeout: 30, CaseSensitive: true, Until: "2019-12-04 02:00:00"}},
		{query: url.Values{"until": []string{"2019-12-04 02:00:00.000"}}, want: &journalArgs{Timeout: 30, CaseSensitive: true, Until: "2019-12-04 02:00:00.000"}},
