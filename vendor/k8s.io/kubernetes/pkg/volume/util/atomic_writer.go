...
func shouldWritePayload(payload map[string][]byte, oldTsDir string) (bool, error) {
...
func (w *AtomicWriter) pathsToRemove(payload map[string][]byte, oldTsDir string) (sets.String, error) {
