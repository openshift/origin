...
func logsForObjectOrigin(restClientGetter genericclioptions.RESTClientGetter, object, options runtime.Object, timeout time.Duration) (*rest.Request, error) {
	...
	default:
		return logsForObject(restClientGetter, object, options, timeout)
	}
}
