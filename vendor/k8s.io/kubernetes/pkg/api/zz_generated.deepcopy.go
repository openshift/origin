...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_AzureFilePersistentVolumeSource, InType: reflect.TypeOf(&AzureFileVolumeSource{})},
		...
		*out = *in
		...
		if in.AzureFile != nil {
			...
			*out = new(AzureFilePersistentVolumeSource)
			if err := DeepCopy_api_AzureFilePersistentVolumeSource(*in, *out, c); err != nil {
				return err
			}
		}
