...
func (m *SecurityContextConstraints) MarshalTo(data []byte) (int, error) {
	...
	n149, err := m.SELinuxContext.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n149
	...
	n150, err := m.RunAsUser.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n150
	...
	n151, err := m.SupplementalGroups.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n151
	...
	n152, err := m.FSGroup.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n152
