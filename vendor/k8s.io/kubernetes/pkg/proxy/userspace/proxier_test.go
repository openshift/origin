...
func TestOnServiceAddChangeMap(t *testing.T) {
	...
	serviceUpdate := &api.Service{
		ObjectMeta: serviceMeta,
		Spec: api.ServiceSpec{ClusterIP: "1.2.3.5", Ports: []api.ServicePort{{
			Name:     "p",
			Port:     100,
			Protocol: "TCP",
		}}},
	...
	serviceUpdate2 := &api.Service{
		ObjectMeta: serviceMeta,
		Spec: api.ServiceSpec{ClusterIP: "1.2.3.6", Ports: []api.ServicePort{{
			Name:     "p",
			Port:     101,
			Protocol: "TCP",
		}}},
