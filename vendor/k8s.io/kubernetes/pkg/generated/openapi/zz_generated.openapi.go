...
func GetOpenAPIDefinitions(ref openapi.ReferenceCallback) map[string]openapi.OpenAPIDefinition {
	return map[string]openapi.OpenAPIDefinition{
		...
		"k8s.io/apiserver/pkg/apis/audit/v1alpha1.Event": {
			...
			Dependencies: []string{
				"k8s.io/api/authentication/v1.UserInfo", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "k8s.io/apimachinery/pkg/apis/meta/v1.Status", "k8s.io/apimachinery/pkg/apis/meta/v1.Time", "k8s.io/apimachinery/pkg/runtime.Unknown", "k8s.io/apiserver/pkg/apis/audit/v1alpha1.ObjectReference"},
		},
		...
		"k8s.io/kubernetes/federation/apis/federation/v1beta1.ClusterSpec": {
			...
			Dependencies: []string{
				"k8s.io/api/core/v1.LocalObjectReference", "k8s.io/kubernetes/federation/apis/federation/v1beta1.ServerAddressByClientCIDR"},
		},
		...
		"k8s.io/kubernetes/pkg/apis/componentconfig/v1alpha1.KubeletConfiguration": {
			...
			Dependencies: []string{
				"k8s.io/api/core/v1.Taint", "k8s.io/apimachinery/pkg/apis/meta/v1.Duration", "k8s.io/kubernetes/pkg/apis/componentconfig/v1alpha1.KubeletAuthentication", "k8s.io/kubernetes/pkg/apis/componentconfig/v1alpha1.KubeletAuthorization"},
		},
		...
		"k8s.io/metrics/pkg/apis/custom_metrics/v1alpha1.MetricValue": {
			...
			Dependencies: []string{
				"k8s.io/api/core/v1.ObjectReference", "k8s.io/apimachinery/pkg/api/resource.Quantity", "k8s.io/apimachinery/pkg/apis/meta/v1.Time"},
		},
