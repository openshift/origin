...
func newSecurityContextConstraintsInformer(client kubernetes.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	sharedIndexInformer := cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				return client.CoreV1().SecurityContextConstraints().List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				return client.CoreV1().SecurityContextConstraints().Watch(options)
			},
		},
		&api_v1.SecurityContextConstraints{},
		resyncPeriod,
...
func (f *securityContextConstraintsInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&api_v1.SecurityContextConstraints{}, newSecurityContextConstraintsInformer)
}
