...
func main() {
	...
	if *test {
		arguments.InputDirs = append(dependencies, []string{
			"k8s.io/code-generator/cmd/client-gen/test_apis/testgroup",
		}...)
		arguments.CustomArgs = clientgenargs.Args{
			...
			GroupVersionToInputPath: map[types.GroupVersion]string{
				{Group: "testgroup", Version: ""}: "k8s.io/code-generator/cmd/client-gen/test_apis/testgroup",
			},
			ClientsetName:       "test_internalclientset",
			ClientsetOutputPath: "k8s.io/code-generator/cmd/client-gen/testoutput/clientset_generated/",
			ClientsetOnly:       false,
			FakeClient:          true,
			CmdArgs:             cmdArgs,
		}
