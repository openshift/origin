...
func TestPodAdmission(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			mergedTolerations:         []api.Toleration{{Key: "testKey", Operator: "Equal", Value: "testValue1", Effect: "NoSchedule"}, {Key: "testKey", Operator: "Equal", Value: "testValue", Effect: "NoSchedule"}},
			admit:                     true,
