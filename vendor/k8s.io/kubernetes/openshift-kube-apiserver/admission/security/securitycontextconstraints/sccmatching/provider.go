...
import (
	...
	"k8s.io/kubernetes/openshift-kube-apiserver/admission/security/securitycontextconstraints/capabilities"
	"k8s.io/kubernetes/openshift-kube-apiserver/admission/security/securitycontextconstraints/group"
	"k8s.io/kubernetes/openshift-kube-apiserver/admission/security/securitycontextconstraints/seccomp"
	"k8s.io/kubernetes/openshift-kube-apiserver/admission/security/securitycontextconstraints/selinux"
	"k8s.io/kubernetes/openshift-kube-apiserver/admission/security/securitycontextconstraints/user"
