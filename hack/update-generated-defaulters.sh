...
defaulter-gen   --input-dirs $(codegen::join , "${ALL_FQ_APIS[@]}") --extra-peer-dirs $(codegen::join , "${ALL_PEERS[@]}") --build-tag=ignore_autogenerated_openshift -O zz_generated.defaults --go-header-file ${SCRIPT_ROOT}/hack/boilerplate.txt --v=8 "$@"
