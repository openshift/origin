...
OPENSHIFT_SKIP_EXTERNAL_TESTS=1 go run -mod vendor ./cmd/openshift-tests images --upstream --to-repository quay.io/openshift/community-e2e-images | grep "quay.io/openshift/community-e2e-images" >> test/extended/util/image/zz_generated.txt
