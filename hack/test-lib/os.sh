...
# VERBOSE=true os::cmd::expect_success_and_not_text './container; docker ps -a' 'origin'
os::cmd::expect_success_and_not_text './server; ps -A' 'openshift'
os::cmd::expect_success_and_not_text './master; ps -A' 'origin'
