...
${CODEGEN_PKG}/generate-groups.sh "client,lister,informer" \
  github.com/openshift/origin/pkg/cmd/openshift-operators/apiserver-operator/generated \
  github.com/openshift/origin/pkg/cmd/openshift-operators/apiserver-operator/apis \
  "apiserver:v1" \
  --go-header-file ${SCRIPT_ROOT}/hack/boilerplate.txt \
  ${verify}

${CODEGEN_PKG}/generate-groups.sh "client,lister,informer" \
  github.com/openshift/origin/pkg/cmd/openshift-operators/controller-operator/generated \
  github.com/openshift/origin/pkg/cmd/openshift-operators/controller-operator/apis \
  "controller:v1" \
  --go-header-file ${SCRIPT_ROOT}/hack/boilerplate.txt \
  ${verify}

${CODEGEN_PKG}/generate-groups.sh "client,lister,informer" \
  github.com/openshift/origin/pkg/cmd/openshift-operators/webconsole-operator/generated \
  github.com/openshift/origin/pkg/cmd/openshift-operators/webconsole-operator/apis \
  "webconsole:v1" \
  --go-header-file ${SCRIPT_ROOT}/hack/boilerplate.txt \
  ${verify}

${CODEGEN_PKG}/generate-groups.sh "client,lister,informer" \
  github.com/openshift/origin/pkg/cmd/openshift-operators/orchestration-operator/generated \
  github.com/openshift/origin/pkg/cmd/openshift-operators/orchestration-operator/apis \
  "orchestration:v1" \
  --go-header-file ${SCRIPT_ROOT}/hack/boilerplate.txt \
  ${verify}
