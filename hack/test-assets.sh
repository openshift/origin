...
pushd "${OS_ROOT}" > /dev/null
  ...
  Godeps/_workspace/bin/go-bindata -nocompress -modtime=1 -mode=493 -prefix "assets/dist"      -pkg "assets" -o "_output/test/assets/bindata.go"      -ignore "\\.gitignore" assets/dist/...
  Godeps/_workspace/bin/go-bindata -nocompress -modtime=1 -mode=493 -prefix "assets/dist.java" -pkg "java"   -o "_output/test/assets/java/bindata.go" -ignore "\\.gitignore" assets/dist.java/...
