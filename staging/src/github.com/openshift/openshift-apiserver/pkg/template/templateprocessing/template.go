...
import (
	...
	"github.com/openshift/library-go-staging/template/labels"
	"github.com/openshift/library-go-staging/template/stringreplace"
	"github.com/openshift/openshift-apiserver/apis/internalversion/legacygroupification"
