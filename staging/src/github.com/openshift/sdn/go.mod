...
replace (
	...
	github.com/openshift/oauth-server => ../oauth-server
	github.com/openshift/oc => ../oc
	github.com/openshift/openshift-apiserver => ../openshift-apiserver
	github.com/openshift/openshift-controller-manager => ../openshift-controller-manager
	github.com/openshift/sdn => ../sdn
	github.com/openshift/source-to-image => github.com/openshift/source-to-image v0.0.0-20180919145318-3dee73c8b7
	github.com/openshift/template-service-broker => ../template-service-broker
	...
	k8s.io/api => ../../../../../staging-kube/src/k8s.io/api
	k8s.io/apiextensions-apiserver => ../../../../../staging-kube/src/k8s.io/apiextensions-apiserver
	k8s.io/apimachinery => ../../../../../staging-kube/src/k8s.io/apimachinery
	k8s.io/apiserver => ../../../../../staging-kube/src/k8s.io/apiserver
	k8s.io/cli-runtime => ../../../../../staging-kube/src/k8s.io/cli-runtime
	k8s.io/client-go => ../../../../../staging-kube/src/k8s.io/client-go
	k8s.io/cloud-provider => ../../../../../staging-kube/src/k8s.io/cloud-provider
	k8s.io/cluster-bootstrap => ../../../../../staging-kube/src/k8s.io/cluster-bootstrap
	k8s.io/code-generator => ../../../../../staging-kube/src/k8s.io/code-generator
	k8s.io/component-base => ../../../../../staging-kube/src/k8s.io/component-base
	k8s.io/csi-api => ../../../../../staging-kube/src/k8s.io/csi-api
	k8s.io/csi-translation-lib => ../../../../../staging-kube/src/k8s.io/csi-translation-lib
	...
	k8s.io/kube-aggregator => ../../../../../staging-kube/src/k8s.io/kube-aggregator
	k8s.io/kube-controller-manager => ../../../../../staging-kube/src/k8s.io/kube-controller-manager
	k8s.io/kube-openapi => github.com/kubernetes/kube-openapi v0.0.0-20190702153934-b3a7cee44a
	k8s.io/kube-proxy => ../../../../../staging-kube/src/k8s.io/kube-proxy
	k8s.io/kube-scheduler => ../../../../../staging-kube/src/k8s.io/kube-scheduler
	k8s.io/kubelet => ../../../../../staging-kube/src/k8s.io/kubelet
	k8s.io/kubernetes => github.com/openshift/kubernetes v0.0.0-20180919145318-3a0658d1a4
	k8s.io/metrics => ../../../../../staging-kube/src/k8s.io/metrics
	k8s.io/node-api => ../../../../../staging-kube/src/k8s.io/node-api
	k8s.io/sample-apiserver => ../../../../../staging-kube/src/k8s.io/sample-apiserver
	k8s.io/sample-cli-plugin => ../../../../../staging-kube/src/k8s.io/sample-cli-plugin
	k8s.io/sample-controller => ../../../../../staging-kube/src/k8s.io/sample-controller
