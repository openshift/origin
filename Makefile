...
#   make build-all
build-all:
	hack/build-go.sh cmd/hypershift vendor/k8s.io/kubernetes/cmd/hyperkube cmd/oc staging/src/github.com/openshift/sdn/cmd/openshift-sdn cmd/openshift-tests
.PHONY: build-all
...
build-network:
	hack/build-go.sh staging/src/github.com/openshift/sdn/cmd/openshift-sdn staging/src/github.com/openshift/sdn/cmd/sdn-cni-plugin vendor/github.com/containernetworking/plugins/plugins/ipam/host-local vendor/github.com/containernetworking/plugins/plugins/main/loopback
.PHONY: build-network
