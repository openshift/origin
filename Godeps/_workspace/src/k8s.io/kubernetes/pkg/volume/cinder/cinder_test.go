...
func (fake *fakePDManager) CreateVolume(c *cinderVolumeCreater) (string, int, error) {
	return "test-volume-name", 1024 * 1024 * 1024, nil
}
...
func TestPlugin(t *testing.T) {
	...
	creater, err := plug.(*cinderPlugin).newCreaterInternal(options, &fakePDManager{})
	...
	provisioner, err := plug.(*cinderPlugin).newCreaterInternal(options, &fakePDManager{})
