...
func (fake *fakePDManager) CreateVolume(c *gcePersistentDiskCreater) (string, int, error) {
...
func TestPlugin(t *testing.T) {
	...
	creater, err := plug.(*gcePersistentDiskPlugin).newCreaterInternal(options, &fakePDManager{})
	...
	provisioner, err := plug.(*gcePersistentDiskPlugin).newCreaterInternal(options, &fakePDManager{})
