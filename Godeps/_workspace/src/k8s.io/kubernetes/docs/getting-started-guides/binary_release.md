...
The list of binary releases is available for download from the [GitHub Kubernetes repo release page](https://k8s.io/kubernetes/releases).
...
```bash
git clone https://k8s.io/kubernetes.git
cd kubernetes
make release
```
