...
Download the [latest binary release](https://k8s.io/kubernetes/releases/latest) and unzip it.
...
- Use images hosted on Google Container Registry (GCR):
  - e.g `gcr.io/google_containers/kube-apiserver:$TAG`, where `TAG` is the latest
    release tag, which can be found on the [latest releases page](https://k8s.io/kubernetes/releases/latest).
