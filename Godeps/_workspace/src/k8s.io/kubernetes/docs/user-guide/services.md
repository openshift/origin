...
portals](https://k8s.io/kubernetes/issues/1107) for more
details.
...
There's a
[proposal](https://k8s.io/kubernetes/issues/3760) to
...
object](https://htmlpreview.github.io/?https://k8s.io/kubernetes/HEAD/docs/api-reference/definitions.html#_v1_service).
