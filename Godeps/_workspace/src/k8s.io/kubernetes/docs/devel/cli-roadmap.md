...
* [area/app-config-deployment](https://k8s.io/kubernetes/labels/area/app-config-deployment)
* [component/CLI](https://k8s.io/kubernetes/labels/component/CLI)
* [component/client](https://k8s.io/kubernetes/labels/component/client)
