...
os::cmd::expect_success 'oc delete service,deploymentconfig -l app=mysql'
...
os::cmd::expect_success 'oc delete service,deploymentconfig -l no-source=php-mysql'
os::cmd::expect_success 'oc delete all -l no-source=php-mysql'
os::cmd::expect_success 'oc new-app php mysql'
os::cmd::expect_success 'oc delete service,deploymentconfig -l app=php'
...
os::cmd::expect_success 'oc delete deploymentconfig,buildconfig -l app=testapp2'
os::cmd::expect_success 'oc delete imagestream -l app=testapp2'
os::cmd::expect_success 'oc delete deploymentconfig,buildconfig -l app=testapp1'
os::cmd::expect_success 'oc delete imagestream -l app=testapp1'
...
os::cmd::expect_success 'oc delete route,service,deploymentconfig,buildconfig -l app=helloworld'
os::cmd::expect_success 'oc delete imagestream -l app=helloworld'
...
os::cmd::expect_success 'oc delete service,deploymentconfig,buildconfig -l app=ruby'
os::cmd::expect_success 'oc delete imagestream -l app=ruby'
os::cmd::expect_success 'oc delete all -l app=ruby'
