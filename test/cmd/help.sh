...
os::cmd::expect_success_and_text 'oc adm' 'Administrative Commands'
os::cmd::expect_success_and_text 'openshift admin' 'Administrative Commands'
os::cmd::expect_success_and_text 'oc adm' 'Component Installation:'
os::cmd::expect_success_and_text 'oc adm' 'Security and Policy:'
...
os::cmd::expect_success_and_text 'oc adm --help' 'Administrative Commands'
