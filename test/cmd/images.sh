...
os::cmd::expect_success_and_text 'oc get istag/wildfly:latest -o jsonpath={.tag.from.name}' '14.0'
...
os::cmd::expect_success 'oc create imagestreamtag tag:1 --from=wildfly:14.0'
...
os::cmd::expect_success 'oc create imagestreamtag tag-b:1 --from=wildfly:14.0'
...
tag1=$( oc get istag/wildfly:14.0 -o jsonpath={.image.metadata.name} )
