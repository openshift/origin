...
test::junit::declare_package_start "test-cmd/images"
	oc get images
	oc create -f test/integration/fixtures/test-image.json
	oc delete images test
	echo "images: ok"

	test::junit::declare_package_start "test-cmd/images/imagestreams"
		oc get imageStreams
	...
	test::junit::declare_package_start "test-cmd/images/import"
	...
	test::junit::declare_package_start "test-cmd/images/tag"
		# oc tag
	...
	test::junit::declare_package_start "test-cmd/images/delete_imagestream_tag"
