...
test::junit::declare_package_start "test-cmd/templates"
	oc get templates
	...
	test::junit::declare_package_start "test-cmd/templates/config"
	...
	test::junit::declare_package_start "test-cmd/templates/precision"
	...
	test::junit::declare_package_start "test-cmd/templates/config/namespaces"
