...
test::junit::declare_package_start "test-cmd/admin"
    # Test admin manage-node operations
    test::junit::declare_package_start "test-cmd/admin/manage-node"
    ...
    test::junit::declare_package_start "test-cmd/admin/groups"
    ...
    # Test admin policy actions
    test::junit::declare_package_start "test-cmd/admin/policy"
    ...
    test::junit::declare_package_start "test-cmd/admin/ui-project-commands"
    ...
    test::junit::declare_package_start "test-cmd/admin/new-project"
    ...
    test::junit::declare_package_start "test-cmd/admin/router"
    ...
    test::junit::declare_package_start "test-cmd/admin/registry"
    ...
    test::junit::declare_package_start "test-cmd/admin/complex-scenarios"
    ...
    test::junit::declare_package_start "test-cmd/admin/reconcile-scc"
