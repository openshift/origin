...
test::junit::declare_package_start "test-cmd/builds"
	...
	test::junit::declare_package_start "test-cmd/builds/patch"
	...
	test::junit::declare_package_start "test-cmd/builds/config"
	...
	test::junit::declare_package_start "test-cmd/builds/start"
	...
	test::junit::declare_package_start "test-cmd/builds/cancel"
