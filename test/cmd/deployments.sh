...
test::junit::declare_package_start "test-cmd/deployments"
	test::junit::declare_package_start "test-cmd/deployments/config"
	...
	test::junit::declare_package_start "test-cmd/deployments/scale"
	...
	test::junit::declare_package_start "test-cmd/deployments/rollback"
	...
	test::junit::declare_package_start "test-cmd/deployments/stop"
		oc get dc/database
