...
test::junit::declare_package_start "test-cmd/basicresources"
	test::junit::declare_package_start "test-cmd/basicresources/resource-builder"
	...
	test::junit::declare_package_start "test-cmd/basicresources/pods"
	...
	test::junit::declare_package_start "test-cmd/basicresources/labels"
	...
	test::junit::declare_package_start "test-cmd/basicresources/services"
		oc get services
	...
	test::junit::declare_package_start "test-cmd/basicresources/version_conversion"
	...
	test::junit::declare_package_start "test-cmd/basicresources/nodes"
		oc get nodes
		(
	...
	test::junit::declare_package_start "test-cmd/basicresources/routes"
		oc get routes
	...
	test::junit::declare_package_start "test-cmd/basicresources/expose"
	...
	test::junit::declare_package_start "test-cmd/basicresources/non-admin"
