...
os::cmd::expect_success_and_text "oc set build-hook ${arg} --local --post-commit -o yaml -- echo 'hello world'" 'postCommit:'
os::cmd::expect_success_and_text "oc set build-hook ${arg} --local --post-commit -o yaml -- echo 'hello world'" 'args:'
os::cmd::expect_success_and_text "oc set build-hook ${arg} --local --post-commit -o yaml -- echo 'hello world'" '\- echo'
os::cmd::expect_success_and_text "oc set build-hook ${arg} --local --post-commit -o yaml -- echo 'hello world'" '\- hello world'
os::cmd::expect_success_and_not_text "oc set build-hook ${arg} --local --post-commit -o yaml -- echo 'hello world'" 'command:'
...
os::cmd::expect_success_and_text "oc set build-hook bc/test-buildconfig --v=1 --post-commit -- echo 'hello world'" "was not changed"
