...
func TestResourceAccessReview(t *testing.T) {
	...
	{
		test := resourceAccessReviewTest{
			clientInterface: openshiftClient.ResourceAccessReviews(""),
			review:          requestWhoCanViewDeployments,
...
func TestSubjectAccessReview(t *testing.T) {
	...
	subjectAccessReviewTest{
		clientInterface: openshiftClient.SubjectAccessReviews(""),
	...
	subjectAccessReviewTest{
		clientInterface: haroldClient.SubjectAccessReviews(""),
		review:          askCanClusterAdminsCreateProject,
		err:             "Forbidden",
	}.run(t)
}
