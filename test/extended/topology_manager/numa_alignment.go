// TODO: this is a verbatim copy paste (just the package name changed) from k8s u/s.
// We need to make this code public u/s before we can remove this duplicate.
