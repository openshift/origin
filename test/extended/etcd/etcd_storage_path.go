...
func testEtcd3StoragePath(t g.GinkgoTInterface, oc *exutil.CLI, etcdClient3Fn func() (etcdv3.KV, error)) {
	...
	if strings.HasPrefix(version.Minor, "37") {
		for k, a := range map[schema.GroupVersionResource]etcddata.StorageData{
			// Added etcd data.
			// TODO: When rebase has started, add etcd storage data that has been added to
			//       k8s.io/kubernetes/test/integration/etcd/data.go in the 1.37 release.
			...
			gvr("scheduling.k8s.io", "v1alpha3", "compositepodgroups"): {
				...
				ExpectedEtcdPath:  "/registry/compositepodgroups/" + oc.Namespace() + "/cpg1",
				IntroducedVersion: "1.37",
				RemovedVersion:    "1.42",
			},
			...
			gvr("scheduling.k8s.io", "v1beta1", "workloads"): {
				...
				ExpectedEtcdPath:  "/registry/workloads/" + oc.Namespace() + "/w2",
				IntroducedVersion: "1.37",
				RemovedVersion:    "1.43",
			},
			gvr("scheduling.k8s.io", "v1beta1", "podgroups"): {
				...
				ExpectedEtcdPath:  "/registry/podgroups/" + oc.Namespace() + "/pg2",
				IntroducedVersion: "1.37",
				RemovedVersion:    "1.43",
			},
			gvr("certificates.k8s.io", "v1", "podcertificaterequests"): {
				...
				ExpectedEtcdPath:  "/registry/podcertificaterequests/" + oc.Namespace() + "/req-2",
			...
			gvr("lifecycle.k8s.io", "v1alpha1", "evictionrequests"): {
				...
				ExpectedEtcdPath:  "/registry/evictionrequests/" + oc.Namespace() + "/pod-eviction-request",
			...
			gvr("lifecycle.k8s.io", "v1alpha1", "evictions"): {
				...
				ExpectedEtcdPath:  "/registry/evictions/" + oc.Namespace() + "/pod-1-my-workload",
		...
		//       in k8s.io/kubernetes/test/integration/etcd/data.go in the 1.37 release.
		alternateImage := image.GetE2EImage(image.Etcd)
		image := image.GetE2EImage(image.BusyBox)
		etcdStorageData[gvr("", "v1", "services")] = etcddata.StorageData{
			...
			ExpectedEtcdPath:  "/registry/services/specs/" + oc.Namespace() + "/service1",
		...
		etcdStorageData[gvr("", "v1", "pods")] = etcddata.StorageData{
			...
			ExpectedEtcdPath:  "/registry/pods/" + oc.Namespace() + "/pod1",
			IntroducedVersion: "1.0",
		}
		etcdStorageData[gvr("", "v1", "resourcequotas")] = etcddata.StorageData{
			Stub:              `{"metadata": {"name": "rq1name"}, "spec": {"hard": {"cpu": "5M"}}}`,
			MutatedStub:       `{"spec": {"hard": {"cpu": "25M"}}}`,
			ExpectedEtcdPath:  "/registry/resourcequotas/" + oc.Namespace() + "/rq1name",
			IntroducedVersion: "1.0",
			StatusStub:        `{"status": {"used": {"cpu": "5M"}}}`,
			MutatedStatusStub: `{"status": {"used": {"cpu": "25M"}}}`,
		}
		etcdStorageData[gvr("", "v1", "namespaces")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("", "v1", "nodes")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("", "v1", "persistentvolumes")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("", "v1", "persistentvolumeclaims")] = etcddata.StorageData{
			...
			ExpectedEtcdPath:  "/registry/persistentvolumeclaims/" + oc.Namespace() + "/pvc1",
			IntroducedVersion: "1.0",
		}
		etcdStorageData[gvr("", "v1", "replicationcontrollers")] = etcddata.StorageData{
			...
			ExpectedEtcdPath:  "/registry/controllers/" + oc.Namespace() + "/rc1",
			IntroducedVersion: "1.0",
		}
		etcdStorageData[gvr("apps", "v1", "daemonsets")] = etcddata.StorageData{
			...
			ExpectedEtcdPath:  "/registry/daemonsets/" + oc.Namespace() + "/ds6",
			IntroducedVersion: "1.9",
		}
		etcdStorageData[gvr("apps", "v1", "deployments")] = etcddata.StorageData{
			...
			ExpectedEtcdPath:  "/registry/deployments/" + oc.Namespace() + "/deployment4",
			IntroducedVersion: "1.9",
		}
		...
		etcdStorageData[gvr("apps", "v1", "replicasets")] = etcddata.StorageData{
			...
			ExpectedEtcdPath:  "/registry/replicasets/" + oc.Namespace() + "/rs3",
			IntroducedVersion: "1.9",
		}
		...
		etcdStorageData[gvr("batch", "v1", "jobs")] = etcddata.StorageData{
			...
			ExpectedEtcdPath:  "/registry/jobs/" + oc.Namespace() + "/job1",
			IntroducedVersion: "1.2",
		}
		etcdStorageData[gvr("batch", "v1", "cronjobs")] = etcddata.StorageData{
			...
			ExpectedEtcdPath:  "/registry/cronjobs/" + oc.Namespace() + "/cjv1",
		...
		etcdStorageData[gvr("networking.k8s.io", "v1", "ingresses")] = etcddata.StorageData{
			...
			ExpectedEtcdPath:  "/registry/ingress/" + oc.Namespace() + "/ingress3",
		...
		etcdStorageData[gvr("flowcontrol.apiserver.k8s.io", "v1", "flowschemas")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("flowcontrol.apiserver.k8s.io", "v1", "prioritylevelconfigurations")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("storage.k8s.io", "v1", "volumeattachments")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("apiregistration.k8s.io", "v1", "apiservices")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("apiextensions.k8s.io", "v1", "customresourcedefinitions")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("awesome.bears.com", "v1", "pandas")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("awesome.bears.com", "v3", "pandas")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("resource.k8s.io", "v1beta2", "devicetaintrules")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("internal.apiserver.k8s.io", "v1alpha1", "storageversions")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("certificates.k8s.io", "v1beta1", "podcertificaterequests")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("resource.k8s.io", "v1alpha3", "resourcepoolstatusrequests")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("scheduling.k8s.io", "v1alpha3", "podgroups")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("scheduling.k8s.io", "v1alpha3", "workloads")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("storagemigration.k8s.io", "v1beta1", "storageversionmigrations")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("certificates.k8s.io", "v1beta1", "clustertrustbundles")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("admissionregistration.k8s.io", "v1", "mutatingadmissionpolicies")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("admissionregistration.k8s.io", "v1", "mutatingadmissionpolicybindings")] = etcddata.StorageData{
		...
		etcdStorageData[gvr("storage.k8s.io", "v1", "csinodes")] = etcddata.StorageData{
		...
		//       from k8s.io/kubernetes/test/integration/etcd/data.go in the 1.37 release.
	}
