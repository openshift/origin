...
var _ = g.Describe("[sig-api-machinery][Feature:ClusterResourceQuota]", func() {
	...
	g.Describe("Cluster resource quota", func() {
		g.It("should control resource limits across namespaces [apigroup:quota.openshift.io][apigroup:image.openshift.io][apigroup:monitoring.coreos.com][apigroup:template.openshift.io]", func() {
			t := g.GinkgoT(1)
