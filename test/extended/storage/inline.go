...
var _ = g.Describe("[sig-storage][Feature:CSIInlineVolumeAdmission][Serial]", func() {
	...
	g.Context("privileged namespace", func() {
		var (
			oc = exutil.NewCLI(exutil.CliOptions{BaseName: "inline-vol-privileged-ns", PodSecurityEnforceLevel: admissionapi.LevelPrivileged})
		)
	...
	g.Context("baseline namespace", func() {
		var (
			oc = exutil.NewCLI(exutil.CliOptions{BaseName: "inline-vol-baseline-ns", PodSecurityEnforceLevel: admissionapi.LevelBaseline})
		)
	...
	g.Context("restricted namespace", func() {
		var (
			oc = exutil.NewCLI(exutil.CliOptions{BaseName: "inline-vol-restricted-ns", PodSecurityEnforceLevel: admissionapi.LevelRestricted})
		)
