...
var _ = g.Describe("[sig-auth][Feature:ProjectAPI] ", func() {
	...
	g.Describe("TestProjectIsNamespace", func() {
		g.It("should succeed [apigroup:project.openshift.io]", func() {
			t := g.GinkgoT()
...
var _ = g.Describe("[sig-auth][Feature:ProjectAPI] ", func() {
	...
	g.Describe("TestProjectWatch", func() {
		g.It("should succeed [apigroup:project.openshift.io][apigroup:authorization.openshift.io][apigroup:user.openshift.io]", func() {
...
var _ = g.Describe("[sig-auth][Feature:ProjectAPI] ", func() {
	...
	g.Describe("TestScopedProjectAccess", func() {
		g.It("should succeed [apigroup:user.openshift.io][apigroup:project.openshift.io][apigroup:authorization.openshift.io]", func() {
			t := g.GinkgoT()
...
var _ = g.Describe("[sig-auth][Feature:ProjectAPI] ", func() {
	...
	g.Describe("TestInvalidRoleRefs", func() {
		g.It("should succeed [apigroup:authorization.openshift.io][apigroup:user.openshift.io][apigroup:project.openshift.io]", func() {
