...
var _ = g.Describe("[sig-auth][Feature:PodSecurity]", func() {
	...
	oc := exutil.NewCLI(exutil.CliOptions{BaseName: "pod-security", PodSecurityEnforceLevel: psapi.LevelRestricted})
...
var _ = g.Describe("[sig-auth][Feature:PodSecurity][Feature:SCC]", func() {
	...
	oc := exutil.NewCLI(exutil.CliOptions{BaseName: "pod-security-scc-mutation", PodSecurityEnforceLevel: psapi.LevelRestricted})
