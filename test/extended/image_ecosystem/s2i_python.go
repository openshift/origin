...
var _ = g.Describe("[sig-devex][Feature:ImageEcosystem][python][Slow] hot deploy for openshift python image", func() {
	...
	g.Context("", func() {
		...
		g.Describe("Django example", func() {
			g.It("should work with hot deploy [apigroup:image.openshift.io][apigroup:operator.openshift.io][apigroup:config.openshift.io][apigroup:build.openshift.io]", func() {
