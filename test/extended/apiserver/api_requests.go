	...
	g.It("operators should not create watch channels very often", func() {
		...
		upperBounds := map[configv1.PlatformType]platformUpperBound{
			configv1.AWSPlatformType: {
				...
				"cluster-monitoring-operator":            37,
			...
			configv1.AzurePlatformType: {
				"authentication-operator":                258,
				"cloud-credential-operator":              33,
				"cluster-autoscaler-operator":            35,
				"cluster-baremetal-operator":             35,
				"cluster-image-registry-operator":        86,
				"cluster-monitoring-operator":            47,
				"cluster-node-tuning-operator":           34,
				"cluster-samples-operator":               24,
				"cluster-storage-operator":               143,
				"console-operator":                       94,
				"csi-snapshot-controller-operator":       46,
				"dns-operator":                           43,
				"etcd-operator":                          126,
				"ingress-operator":                       388,
				"kube-apiserver-operator":                198,
				"kube-controller-manager-operator":       136,
				"kube-storage-version-migrator-operator": 33,
				"machine-api-operator":                   35,
				"marketplace-operator":                   14,
				"openshift-apiserver-operator":           215,
				"openshift-config-operator":              39,
				"openshift-controller-manager-operator":  144,
				"openshift-kube-scheduler-operator":      117,
				"prometheus-operator":                    97,
				"service-ca-operator":                    82,
			},
			...
			configv1.BareMetalPlatformType: {
				...
				"cluster-monitoring-operator":            62,
