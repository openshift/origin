...
func (t *DefaultIngressControllerTLSProfileUpgradeTest) DisplayName() string {
	return "[sig-network-edge][Feature:Router][apigroup:operator.openshift.io] Verify the default IngressController TLS profile is preserved across upgrade"
}
