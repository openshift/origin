...
var _ = g.Describe("[sig-network][OCPFeatureGate:NetworkObservabilityInstall][Feature:NetObserv]", func() {
	...
	g.Context("health checks", func() {
		...
		g.It("should have console plugin healthy [apigroup:console.openshift.io]", func(ctx context.Context) {
		...
		g.It("should have static plugin pods running", func(ctx context.Context) {
