...
func isReady(oc *exutil.CLI, podName string, pingCommand, expectedOutput string) (bool, error) {
...
func executeShellCommand(oc *exutil.CLI, podName string, command string) (string, error) {
