...
func init() {
	allowedImages = map[string]int{
		...
		"k8s.gcr.io/sig-storage/csi-attacher:v3.3.0":                           -1,
		"k8s.gcr.io/sig-storage/csi-external-health-monitor-controller:v0.4.0": -1,
		"k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.1.0":              -1,
		"k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.2.0":              -1,
		"k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.3.0":              -1,
		...
		"k8s.gcr.io/sig-storage/csi-provisioner:v3.0.0":                        -1,
		"k8s.gcr.io/sig-storage/csi-resizer:v1.1.0":                            -1,
		"k8s.gcr.io/sig-storage/csi-resizer:v1.2.0":                            -1,
		"k8s.gcr.io/sig-storage/csi-resizer:v1.3.0":                            -1,
		"k8s.gcr.io/sig-storage/csi-snapshotter:v3.0.2":                        -1,
		"k8s.gcr.io/sig-storage/csi-snapshotter:v3.0.3":                        -1,
		"k8s.gcr.io/sig-storage/csi-snapshotter:v4.0.0":                        -1,
		"k8s.gcr.io/sig-storage/csi-snapshotter:v4.1.1":                        -1,
		"k8s.gcr.io/sig-storage/csi-snapshotter:v4.2.1":                        -1,
		"k8s.gcr.io/sig-storage/hello-populator:v1.0.1":                        -1,
		"k8s.gcr.io/sig-storage/hostpathplugin:v1.7.1":                         -1,
		"k8s.gcr.io/sig-storage/hostpathplugin:v1.7.3":                         -1,
		"k8s.gcr.io/sig-storage/livenessprobe:v2.3.0":                          -1,
		"k8s.gcr.io/sig-storage/livenessprobe:v2.4.0":                          -1,
		...
		"k8s.gcr.io/e2e-test-images/nginx:1.14-2":   22,
