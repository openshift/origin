...
var (
	testMaps = map[string][]string{
		...
		"[Disabled:Unsupported]": {
			...
			`\[sig-storage\] In-tree Volumes \[Driver: vsphere\] \[Testpattern: Pre-provisioned PV \(filesystem volmode\)\] volumeMode should not mount / map unused volumes in a pod \[LinuxOnly\]`,
		},
