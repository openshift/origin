...
var (
	testMaps = map[string][]string{
		...
		"[Skipped:Disconnected]": {
			...
			`\[sig-network\]\[Feature:Router\]\[apigroup:route.openshift.io\]\[apigroup:template.openshift.io\] The HAProxy router should override the route host for overridden domains with a custom value`,
			`\[sig-network\]\[Feature:Router\]\[apigroup:route.openshift.io\]\[apigroup:template.openshift.io\] The HAProxy router should override the route host with a custom value`,
			...
			`\[sig-network\]\[Feature:Router\]\[apigroup:route.openshift.io\]\[apigroup:config.openshift.io\]\[apigroup:template.openshift.io\] The HAProxy router should run even if it has no access to update status`,
			...
			`\[sig-network\]\[Feature:Router\]\[apigroup:route.openshift.io\]\[apigroup:template.openshift.io\] The HAProxy router should serve the correct routes when scoped to a single namespace and label set`,
