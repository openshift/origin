...
var Annotations = map[string]string{
	...
	"[sig-api-machinery][Feature:ResourceQuota] Object count The number of created persistent volume claims can not exceed the limitation": " [Suite:openshift/conformance/parallel]",
