...
var Annotations = map[string]string{
	...
	"[sig-network][OCPFeatureGate:GatewayAPIController][Feature:Router][apigroup:gateway.networking.k8s.io] Verify Gateway API controller and HTTPRoute can be created and accepted": " [Suite:openshift/conformance/parallel]",

	"[sig-network][OCPFeatureGate:GatewayAPIController][Feature:Router][apigroup:gateway.networking.k8s.io] Verify Gateway API controller and ensure OSSM related resources are created when default gatewayclass is accepted": " [Suite:openshift/conformance/parallel]",
