...
var Annotations = map[string]string{
	...
	"[sig-network][Feature:RouteAdvertisements][apigroup:operator.openshift.io] [PodNetwork][apigroup:user.openshift.io][apigroup:security.openshift.io] pods should communicate with external host without being SNATed": " [Suite:openshift/conformance/parallel]",
