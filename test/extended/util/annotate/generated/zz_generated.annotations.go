...
var Annotations = map[string]string{
	...
	"[sig-etcd][Feature:EtcdVerticalScaling][Suite:openshift/etcd/scaling] etcd is able to vertically scale down when a member is unhealthy [apigroup:machine.openshift.io]": "",
