...
var Annotations = map[string]string{
	...
	"[sig-mco][OCPFeatureGate:MachineConfigNode] [Serial][Slow]Should properly create and remove MCN on node creation and deletion [apigroup:machineconfiguration.openshift.io]": "",
