...
var Annotations = map[string]string{
	...
	"[sig-olmv1][OCPFeatureGate:NewOLM] OLMv1 operator installation should block cluster upgrades if an incompatible operator is installed": " [Suite:openshift/conformance/parallel]",

	"[sig-olmv1][OCPFeatureGate:NewOLM] OLMv1 operator installation should install a cluster extension": " [Suite:openshift/conformance/parallel]",
