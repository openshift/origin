...
var Annotations = map[string]string{
	...
	"[sig-etcd][OCPFeatureGate:AutomatedEtcdBackup][Suite:openshift/etcd/scaling] etcd is able to apply the no-config backup configuration [Timeout:50m][apigroup:config.openshift.io/v1alpha1]": "",
