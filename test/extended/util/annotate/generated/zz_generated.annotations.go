...
var Annotations = map[string]string{
	...
	"[sig-network-edge][OCPFeatureGate:GatewayAPIController][Feature:Router][apigroup:gateway.networking.k8s.io] Ensure loadbalancer service and dnsRecord are created for a Gateway object": " [Suite:openshift/conformance/parallel]",
