...
var Annotations = map[string]string{
	...
	"[sig-node][OCPFeatureGate:MinimumKubeletVersion]  admission should allow an empty minimum kubelet version": " [Suite:openshift/conformance/parallel]",

	"[sig-node][OCPFeatureGate:MinimumKubeletVersion]  admission should allow an old minimum kubelet version": " [Suite:openshift/conformance/parallel]",
