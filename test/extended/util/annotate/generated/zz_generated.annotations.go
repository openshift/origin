...
var Annotations = map[string]string{
	...
	"[sig-network][Feature:IPsec] when using openshift ovn-kubernetes check traffic between local pod to a remote pod [apigroup:config.openshift.io] [Suite:openshift/network/ipsec] with IPsec in disabled mode": "",

	"[sig-network][Feature:IPsec] when using openshift ovn-kubernetes check traffic between local pod to a remote pod [apigroup:config.openshift.io] [Suite:openshift/network/ipsec] with IPsec in external mode": "",
