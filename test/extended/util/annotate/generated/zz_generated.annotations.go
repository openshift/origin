...
var Annotations = map[string]string{
	...
	"[sig-olmv1][OCPFeatureGate:NewOLMWebhookProviderOpenshiftServiceCA][Skipped:Disconnected][Serial] OLMv1 operator with webhooks should still work through openshift-service-ca certificate rotation": " [Suite:openshift/conformance/serial]",
