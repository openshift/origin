...
var Annotations = map[string]string{
	...
	"[sig-olmv1][OCPFeatureGate:NewOLMWebhookProviderOpenshiftServiceCA][Skipped:Disconnected][Serial] OLMv1 operator with webhooks should have a tls secret generated by openshift-serviceca": " [Suite:openshift/conformance/serial]",

	"[sig-olmv1][OCPFeatureGate:NewOLMWebhookProviderOpenshiftServiceCA][Skipped:Disconnected][Serial] OLMv1 operator with webhooks should have a webhook service with openshift-serviceca certificate injection annotation": " [Suite:openshift/conformance/serial]",
