...
var Annotations = map[string]string{
	...
	"[sig-api-machinery][Feature:APIServer] start in-cluster disruption monitors [Early]": " [Suite:openshift/conformance/parallel]",

	"[sig-api-machinery][Feature:APIServer] tear down in-cluster disruption monitors [Late]": " [Suite:openshift/conformance/parallel]",
	...
	"[sig-arch][Feature:ClusterUpgrade] tear down in-cluster disruption monitors [Late][Suite:upgrade]": "",
