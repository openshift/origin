...
var Annotations = map[string]string{
	...
	"[sig-network][Feature:commatrix][Serial] generated communication matrix should be equal to documented communication matrix": " [Suite:openshift/conformance/serial]",
