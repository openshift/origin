...
var Annotations = map[string]string{
	...
	"[sig-olmv1][OCPFeatureGate:NewOLMCatalogdAPIV1Metas][Skipped:Disconnected] OLMv1 Catalogs API Load Test metas endpoint should handle concurrent load with acceptable performance on api/v1/metas endpoint": " [Suite:openshift/conformance/parallel]",
