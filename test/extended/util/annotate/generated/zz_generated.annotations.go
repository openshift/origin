...
var Annotations = map[string]string{
	...
	"[sig-network][OCPFeatureGate:GatewayAPIController][Feature:Router][apigroup:gateway.networking.k8s.io] Verify Gateway API controller and ensure default gateway objects is created": " [Suite:openshift/conformance/parallel]",
