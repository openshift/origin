...
var _ = g.Describe("[Jira:\"Test Framework\"] Prometheus [apigroup:config.openshift.io]", func() {
	...
	g.Describe("when installed on the cluster", func() {
		...
		g.It("shouldn't report any alerts in firing state apart from Watchdog and AlertmanagerReceiversNotConfigured [Early][apigroup:config.openshift.io]", func(ctx g.SpecContext) {
