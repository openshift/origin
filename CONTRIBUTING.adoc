...
12.  NOTE:  the set of steps above have not created a router for you, meaning that if you want to access your pods, you will need to use their ips. https://github.com/openshift/origin/blob/master/docs/routing.md[Routing] contains details on how to setup a router.
