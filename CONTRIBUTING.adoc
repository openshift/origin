...
12.  NOTE:  the set of steps above have not created a router for you, meaning that if you want to access your your pods, you will need to use their ips. https://github.com/openshift/origin/blob/master/docs/routing.md[Routing] contains details on how to setup a router.

13.  You are now ready to edit the source, rebuild and restart OpenShift to test your changes.

14.  NOTE:  to properly stop OpenShift and clean up, so that you can start fresh instance of OpenShift, execute:
